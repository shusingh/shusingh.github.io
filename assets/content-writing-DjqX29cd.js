...
`,e.jsx(a,{steps:["Observe context","Decide next step","Call a tool or model","Update durable state"],decision:"Enough evidence?",yes:"final answer",no:"loop with new state",caption:"The model decides inside a loop, but the application owns execution and state."}),`
...
`,e.jsx(l,{left:{title:"Loaded context",body:"User goal, state, docs, permissions"},center:"Model decision engine",right:[{title:"Answer user"},{title:"Search documents"},{title:"Call safe API"},{title:"Ask clarification"},{title:"Stop"}],caption:"The model chooses from a bounded action surface. The application validates and executes."}),`
...
`,e.jsx(a,{steps:["Receive goal","Load context","Choose action","Execute action","Record result"],decision:"Done?",yes:"return final response",no:"load updated context"}),`
...
`,e.jsx(l,{left:{title:"Agent client",body:"Conversation and model calls"},center:"MCP protocol",right:[{title:"GitHub server",body:"PRs, issues, branches"},{title:"Docs server",body:"Runbooks, specs, internal docs"},{title:"Deploy server",body:"Rollout status and service health"}]}),`
...
`,e.jsx(h,{leftTitle:"Client UI",rightTitle:"Agent runtime",events:[{side:"left",label:"submit question"},{side:"right",label:"status.reading"},{side:"right",label:"tool.started(search)"},{side:"right",label:"tool.completed(12 hits)"},{side:"right",label:"text.delta"},{side:"right",label:"citation.added"},{side:"right",label:"done"}]}),`
...
`]})]})}function S(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(c,{...n})}):c(n)}const se=Object.freeze(Object.defineProperty({__proto__:null,default:S,frontmatter:A},Symbol.toStringTag,{value:"Module"})),C={title:"Choosing analytics for a personal portfolio",date:"2026-05-19",slug:"choosing-analytics-for-a-personal-portfolio",excerpt:"A small engineering decision note on picking analytics for a portfolio site: what to measure, what not to overbuild, and why Microsoft Clarity is a practical fit when the goal is understanding visitor behavior.",readTime:"8 min read",tags:["analytics","frontend","product-engineering","privacy"]};function d(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most personal websites do not need product analytics."}),`
...
`]})]})}function q(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(d,{...n})}):d(n)}const ie=Object.freeze(Object.defineProperty({__proto__:null,default:q,frontmatter:C},Symbol.toStringTag,{value:"Module"})),M={title:"Designing interfaces for agentic systems",date:"2026-05-17",slug:"designing-interfaces-for-agentic-systems",excerpt:"Agentic products need interfaces for supervision, correction, evidence, and safe control. A practical guide to designing UI surfaces for systems that plan, call tools, revise artifacts, and sometimes need to stop.",readTime:"12 min read",tags:["ui","agents","product-engineering","ux"]};function u(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most agent interfaces start as chat boxes."}),`
...
`,e.jsx(I,{title:"Policy draft review",statusItems:["Plan approved","Drafting section 3","Citation check running","Waiting on reviewer"],workspaceTitle:"Artifact",workspaceItems:["Section 3.2: retention exceptions tightened for marketplace launch scope.","Section 3.4: pending reviewer decision on jurisdiction-specific wording.","Critic finding: source coverage missing for deletion request edge case."],evidenceItems:["DSA mapping table v12","Retention policy memo 2026-04","Reviewer note from legal"],actions:["Approve section","Request revision","Add evidence","Rollback"],caption:"The transcript is not the product surface. The artifact, evidence, status, and controls are."}),`
...
`,e.jsx(t.p,{children:"The chat box is a useful input. It should not be the whole interface."})]})}function W(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}const re=Object.freeze(Object.defineProperty({__proto__:null,default:W,frontmatter:M},Symbol.toStringTag,{value:"Module"})),P={title:"Error isolation for batch pipelines: when fail-fast is wrong",date:"2026-05-16",slug:"error-isolation-batch-pipelines",excerpt:"Standard data-engineering advice says validate strictly, fail loudly, and replay. That advice is wrong for any pipeline where one bad record cannot be allowed to block the run. Here is the pattern that replaces it.",readTime:"9 min read",tags:["distributed-systems","data-pipelines","production"]};function p(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The standard advice for batch pipelines is fail-fast."}),`
...
`,e.jsx(a,{steps:["Operator inspects error store","Diagnoses root cause","Fixes source or marks exempted","Triggers replay execution","Replay run processes only errored records"],decision:"Replay successful?",yes:"merge with original run",no:"record new failure reasons"}),`
...
`,e.jsx(a,{steps:["Pick one stage of the old pipeline","Build a Step Functions equivalent","Run both in shadow for one cycle","Compare outputs","Cut over when matched"],decision:"Match rate at 100%?",yes:"cut over",no:"diagnose and adjust"}),`
...
`,e.jsx(t.p,{children:"In our case, it paid for itself in the first month."})]})}function L(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(m,{...n})}):m(n)}const oe=Object.freeze(Object.defineProperty({__proto__:null,default:L,frontmatter:D},Symbol.toStringTag,{value:"Module"})),R={title:"The hidden engineering behind citations in RAG systems",date:"2026-05-23",slug:"hidden-engineering-behind-rag-citations",excerpt:"Citations in RAG systems are not a formatting detail. They are an engineering contract between retrieval, generation, rendering, auditability, and user trust.",readTime:"11 min read",tags:["rag","retrieval","production","ai-infrastructure"]};function g(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most RAG demos treat citations like a UI feature."}),`
...
`,e.jsx(t.p,{children:"That is the whole craft. Most of the rest is execution."})]})}function F(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(f,{...n})}):f(n)}const le=Object.freeze(Object.defineProperty({__proto__:null,default:F,frontmatter:O},Symbol.toStringTag,{value:"Module"})),E={title:"Human feedback is not a chat message",date:"2026-05-15",slug:"human-feedback-is-not-a-chat-message",excerpt:"In production agent systems, human feedback should be modeled as a structured state transition, not appended to a conversation transcript.",readTime:"10 min read",tags:["agents","human-in-the-loop","architecture"]};function x(n){const t={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The easiest way to add human feedback to an agent is to append it to the chat."}),`
...
`,e.jsx(a,{steps:["Model produces artifact","User writes feedback","Feedback joins chat history","Model rewrites from transcript"],decision:"User satisfied?",yes:"ship the latest answer",no:"append another message"}),`
...
`,e.jsx(a,{steps:["Feedback operation","Refiner proposes diff","Critic validates diff","Application commits version"],decision:"Patch valid?",yes:"new canonical version",no:"return findings"}),`
...
`,e.jsx(a,{steps:["New or updated document arrives","Compute chunks","Write BM25 index (immediate)","Enqueue vector embed (async)","Vector index updated when complete"],decision:"Both indexes current?",yes:"serve from hybrid",no:"serve from BM25 only, log degradation"}),`
...
`,e.jsxs(t.p,{children:["If you are wrangling type safety across a client, a backend, and a few third-party APIs that all disagree about reality, ",e.jsx(t.a,{href:"mailto:shubh.singh.dev@gmail.com",children:"get in touch"}),"."]})]})}function Y(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(b,{...n})}):b(n)}const me=Object.freeze(Object.defineProperty({__proto__:null,default:Y,frontmatter:X},Symbol.toStringTag,{value:"Module"})),$={title:"What production agents need that demos do not",date:"2026-05-15",slug:"what-production-agents-need",excerpt:"The gap between an impressive agent demo and a trustworthy production system is not model intelligence. It is state, tools, evals, permissions, observability, retries, and human feedback design.",readTime:"11 min read",tags:["agents","production","architecture"]};function v(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Agent demos are easy to enjoy."}),`
...
`,e.jsx(a,{steps:["Model produces output","Human gives feedback","Feedback joins chat history","Model revises from transcript"],decision:"Reliable enough?",yes:"maybe, for low-stakes work",no:"not for audit-heavy systems"}),`
...
`,e.jsx(t.p,{children:"The future of agents will not be won by the systems with the fanciest demos. It will be won by the systems that make intelligent behavior boring enough to operate."})]})}function Q(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(v,{...n})}):v(n)}const ge=Object.freeze(Object.defineProperty({__proto__:null,default:Q,frontmatter:$},Symbol.toStringTag,{value:"Module"})),K={title:"Why internal tools feel worse than consumer apps",date:"2026-05-27",slug:"why-internal-tools-feel-worse",excerpt:"Internal tools are often built for delivery, not use. The result is software with real business value, captive users, weak ownership, and a surprising amount of avoidable pain.",readTime:"10 min read",tags:["internal-tools","product-engineering","ui","systems"]};function k(n){const t={a:"a",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Internal tools are where product taste goes to be negotiated down."}),`
...
`,e.jsx(o,{left:{eyebrow:"Consumer product",title:"User can leave",items:["Confusion becomes churn","Friction becomes revenue loss","Polish is part of trust","Behavior is measured continuously"]},right:{eyebrow:"Internal product",title:"User must stay",items:["Confusion becomes training","Friction becomes process","Polish is called nice to have","Behavior is rarely measured"]},caption:"Captive users remove market pressure, so the organization has to create quality pressure deliberately."}),`
...
`,e.jsx(t.p,{children:"If the tool is important enough to make people use, it is important enough to make usable."})]})}function Z(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(k,{...n})}):k(n)}const fe=Object.freeze(Object.defineProperty({__proto__:null,default:Z,frontmatter:K},Symbol.toStringTag,{value:"Module"}));export{se as _,ie as a,re as b,ae as c,oe as d,he as e,le as f,ce as g,de as h,ue as i,pe as j,me as k,ge as l,fe as m};
