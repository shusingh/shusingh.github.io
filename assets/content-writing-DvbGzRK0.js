...
`]})]})}function q(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(c,{...n})}):c(n)}const de=Object.freeze(Object.defineProperty({__proto__:null,default:q,frontmatter:W},Symbol.toStringTag,{value:"Module"})),P={title:"Designing interfaces for agentic systems",date:"2026-05-17",slug:"designing-interfaces-for-agentic-systems",excerpt:"Agentic products need interfaces for supervision, correction, evidence, and safe control. A practical guide to designing UI surfaces for systems that plan, call tools, revise artifacts, and sometimes need to stop.",readTime:"12 min read",tags:["ui","agents","product-engineering","ux"]};function u(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most agent interfaces start as chat boxes."}),`
...
`,e.jsx(S,{title:"Policy draft review",statusItems:["Plan approved","Drafting section 3","Citation check running","Waiting on reviewer"],workspaceTitle:"Artifact",workspaceItems:["Section 3.2: retention exceptions tightened for marketplace launch scope.","Section 3.4: pending reviewer decision on jurisdiction-specific wording.","Critic finding: source coverage missing for deletion request edge case."],evidenceItems:["DSA mapping table v12","Retention policy memo 2026-04","Reviewer note from legal"],actions:["Approve section","Request revision","Add evidence","Rollback"],caption:"The transcript is not the product surface. The artifact, evidence, status, and controls are."}),`
...
`,e.jsx(t.p,{children:"The chat box is a useful input. It should not be the whole interface."})]})}function _(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(u,{...n})}):u(n)}const ce=Object.freeze(Object.defineProperty({__proto__:null,default:_,frontmatter:P},Symbol.toStringTag,{value:"Module"})),D={title:"Error isolation for batch pipelines: when fail-fast is wrong",date:"2026-05-16",slug:"error-isolation-batch-pipelines",excerpt:"Standard data-engineering advice says validate strictly, fail loudly, and replay. That advice is wrong for any pipeline where one bad record cannot be allowed to block the run. Here is the pattern that replaces it.",readTime:"9 min read",tags:["distributed-systems","data-pipelines","production"]};function p(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The standard advice for batch pipelines is fail-fast."}),`
...
`,e.jsx(t.p,{children:"In our case, it paid for itself in the first month."})]})}function N(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(m,{...n})}):m(n)}const pe=Object.freeze(Object.defineProperty({__proto__:null,default:N,frontmatter:R},Symbol.toStringTag,{value:"Module"})),O={title:"The hidden engineering behind citations in RAG systems",date:"2026-05-23",slug:"hidden-engineering-behind-rag-citations",excerpt:"Citations in RAG systems are not a formatting detail. They are an engineering contract between retrieval, generation, rendering, auditability, and user trust.",readTime:"11 min read",tags:["rag","retrieval","production","ai-infrastructure"]};function g(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most RAG demos treat citations like a UI feature."}),`
...
`,e.jsx(t.p,{children:"That is the whole craft. Most of the rest is execution."})]})}function U(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(f,{...n})}):f(n)}const ge=Object.freeze(Object.defineProperty({__proto__:null,default:U,frontmatter:E},Symbol.toStringTag,{value:"Module"})),z={title:"Human feedback is not a chat message",date:"2026-05-15",slug:"human-feedback-is-not-a-chat-message",excerpt:"In production agent systems, human feedback should be modeled as a structured state transition, not appended to a conversation transcript.",readTime:"10 min read",tags:["agents","human-in-the-loop","architecture"]};function x(n){const t={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The easiest way to add human feedback to an agent is to append it to the chat."}),`
...
be forgotten again.`}),`
`,e.jsx(t.p,{children:"I do not think that is the right starting point."}),`
`,e.jsx(t.p,{children:`For a personal memory tool, trust is not a feature you bolt on later. It is the
...
`,e.jsx(t.p,{children:"That sounds modest. It is also the point."}),`
...
`,e.jsx(i,{groups:[{title:"Local state",items:["SQLite database","entries","sources","decisions"]},{title:"Explicit actions",items:["capture","import file","preview folder","backup"]},{title:"Optional AI",items:["Ollama detection","local embeddings","drafts only"]}],caption:"The local database is the product boundary; AI can help structure or retrieve, but it does not own the memory."}),`
`,e.jsx(t.p,{children:`That changes the product posture. There is no default cloud account. There is
...
or duplicate files.`}),`
`,e.jsx(t.p,{children:'This is slower than "just index everything."'}),`
`,e.jsx(t.p,{children:"It is also more respectful."}),`
`,e.jsx(t.h2,{id:"memory-needs-a-data-model",children:e.jsx(t.a,{href:"#memory-needs-a-data-model",children:"Memory needs a data model"})}),`
`,e.jsx(t.p,{children:"One mistake in AI products is treating chat history as memory."}),`
`,e.jsx(t.p,{children:`Chat history is context. It is not a durable model of a life, a project, a
...
`,e.jsx(t.p,{children:"Waymark uses a more ordinary shape:"}),`
`,e.jsxs(t.ul,{children:[`
`,e.jsx(t.li,{children:"entries for saved memories"}),`
`,e.jsx(t.li,{children:"tags for lightweight organization"}),`
`,e.jsx(t.li,{children:"sources for imported documents"}),`
`,e.jsx(t.li,{children:"reflections for periodic summaries"}),`
`,e.jsx(t.li,{children:"decisions for choices and later outcomes"}),`
`,e.jsx(t.li,{children:"backup bundles for portability"}),`
`]}),`
`,e.jsx(t.p,{children:"This is not glamorous. It is load-bearing."}),`
`,e.jsx(t.p,{children:"The schema gives the product stable questions to answer:"}),`
`,e.jsxs(t.ul,{children:[`
`,e.jsx(t.li,{children:"What was captured?"}),`
`,e.jsx(t.li,{children:"Where did it come from?"}),`
`,e.jsx(t.li,{children:"Which memories informed this decision?"}),`
`,e.jsx(t.li,{children:"Which imported file supports this answer?"}),`
`,e.jsx(t.li,{children:"What changed since the last reflection?"}),`
`]}),`
...
`,e.jsx(t.p,{children:"A command has to have a contract:"}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-bash",children:`waymark capture --type project "Shipped the first import flow today."
waymark timeline
waymark ask "import flow"
waymark reflect --period week
`})}),`
`,e.jsx(t.p,{children:`There is not much room to hide fuzzy behavior behind UI animation. Inputs,
...
`,e.jsx(o,{steps:["run tests","build package","install fresh wheel","publish from tag"],decision:"Can a new user install it?",yes:"release",no:"fix packaging",caption:"A release workflow should test what users install, not only what developers run from source."}),`
`,e.jsxs(t.p,{children:["One concrete packaging wrinkle: the PyPI name ",e.jsx(t.code,{children:"waymark"}),` was already taken. The
fix was to publish the distribution as `,e.jsx(t.code,{children:"waymark-memory"}),` while keeping the Python
package and console command as `,e.jsx(t.code,{children:"waymark"}),"."]}),`
`,e.jsxs(t.p,{children:[`That required explicit build configuration so the wheel still shipped the
`,e.jsx(t.code,{children:"src/waymark"})," package. Small detail, real release blocker."]}),`
`,e.jsx(t.h2,{id:"what-i-would-do-next",children:e.jsx(t.a,{href:"#what-i-would-do-next",children:"What I would do next"})}),`
`,e.jsx(t.p,{children:"The next version should make retrieval better without making privacy worse."}),`
...
`,e.jsxs(t.p,{children:["If you are wrangling type safety across a client, a backend, and a few third-party APIs that all disagree about reality, ",e.jsx(t.a,{href:"mailto:shubh.singh.dev@gmail.com",children:"get in touch"}),"."]})]})}function te(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(k,{...n})}):k(n)}const ve=Object.freeze(Object.defineProperty({__proto__:null,default:te,frontmatter:ee},Symbol.toStringTag,{value:"Module"})),ne={title:"What production agents need that demos do not",date:"2026-05-15",slug:"what-production-agents-need",excerpt:"The gap between an impressive agent demo and a trustworthy production system is not model intelligence. It is state, tools, evals, permissions, observability, retries, and human feedback design.",readTime:"11 min read",tags:["agents","production","architecture"]};function T(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Agent demos are easy to enjoy."}),`
...
`,e.jsx(t.p,{children:"The future of agents will not be won by the systems with the fanciest demos. It will be won by the systems that make intelligent behavior boring enough to operate."})]})}function se(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(T,{...n})}):T(n)}const ke=Object.freeze(Object.defineProperty({__proto__:null,default:se,frontmatter:ne},Symbol.toStringTag,{value:"Module"})),ie={title:"Why internal tools feel worse than consumer apps",date:"2026-05-27",slug:"why-internal-tools-feel-worse",excerpt:"Internal tools are often built for delivery, not use. The result is software with real business value, captive users, weak ownership, and a surprising amount of avoidable pain.",readTime:"10 min read",tags:["internal-tools","product-engineering","ui","systems"]};function I(n){const t={a:"a",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Internal tools are where product taste goes to be negotiated down."}),`
...
`,e.jsx(t.p,{children:"If the tool is important enough to make people use, it is important enough to make usable."})]})}function re(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(I,{...n})}):I(n)}const Te=Object.freeze(Object.defineProperty({__proto__:null,default:re,frontmatter:ie},Symbol.toStringTag,{value:"Module"}));export{le as _,de as a,ce as b,ue as c,pe as d,me as e,ge as f,fe as g,xe as h,ye as i,je as j,we as k,be as l,ve as m,ke as n,Te as o};
