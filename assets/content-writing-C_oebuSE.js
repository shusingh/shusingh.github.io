...
`,e.jsx(b,{leftTitle:"Client UI",rightTitle:"Agent runtime",events:[{side:"left",label:"submit question"},{side:"right",label:"status.reading"},{side:"right",label:"tool.started(search)"},{side:"right",label:"tool.completed(12 hits)"},{side:"right",label:"text.delta"},{side:"right",label:"citation.added"},{side:"right",label:"done"}]}),`
...
`]})]})}function S(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(c,{...n})}):c(n)}const K=Object.freeze(Object.defineProperty({__proto__:null,default:S,frontmatter:A},Symbol.toStringTag,{value:"Module"})),C={title:"Designing interfaces for agentic systems",date:"2026-05-17",slug:"designing-interfaces-for-agentic-systems",excerpt:"Agentic products need interfaces for supervision, correction, evidence, and safe control. A practical guide to designing UI surfaces for systems that plan, call tools, revise artifacts, and sometimes need to stop.",readTime:"12 min read",tags:["ui","agents","product-engineering","ux"]};function d(n){const t={a:"a",code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most agent interfaces start as chat boxes."}),`
...
`,e.jsx(T,{title:"Policy draft review",statusItems:["Plan approved","Drafting section 3","Citation check running","Waiting on reviewer"],workspaceTitle:"Artifact",workspaceItems:["Section 3.2: retention exceptions tightened for marketplace launch scope.","Section 3.4: pending reviewer decision on jurisdiction-specific wording.","Critic finding: source coverage missing for deletion request edge case."],evidenceItems:["DSA mapping table v12","Retention policy memo 2026-04","Reviewer note from legal"],actions:["Approve section","Request revision","Add evidence","Rollback"],caption:"The transcript is not the product surface. The artifact, evidence, status, and controls are."}),`
...
`,e.jsx(t.p,{children:"The chat box is a useful input. It should not be the whole interface."})]})}function M(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(d,{...n})}):d(n)}const Z=Object.freeze(Object.defineProperty({__proto__:null,default:M,frontmatter:C},Symbol.toStringTag,{value:"Module"})),W={title:"Error isolation for batch pipelines: when fail-fast is wrong",date:"2026-05-16",slug:"error-isolation-batch-pipelines",excerpt:"Standard data-engineering advice says validate strictly, fail loudly, and replay. That advice is wrong for any pipeline where one bad record cannot be allowed to block the run. Here is the pattern that replaces it.",readTime:"9 min read",tags:["distributed-systems","data-pipelines","production"]};function u(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The standard advice for batch pipelines is fail-fast."}),`
...
`,e.jsx(t.p,{children:"In our case, it paid for itself in the first month."})]})}function _(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(p,{...n})}):p(n)}const te=Object.freeze(Object.defineProperty({__proto__:null,default:_,frontmatter:D},Symbol.toStringTag,{value:"Module"})),P={title:"The hidden engineering behind citations in RAG systems",date:"2026-05-23",slug:"hidden-engineering-behind-rag-citations",excerpt:"Citations in RAG systems are not a formatting detail. They are an engineering contract between retrieval, generation, rendering, auditability, and user trust.",readTime:"11 min read",tags:["rag","retrieval","production","ai-infrastructure"]};function m(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Most RAG demos treat citations like a UI feature."}),`
...
`,e.jsx(t.p,{children:"The hidden engineering is everything that makes the citation mean something."})]})}function L(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(m,{...n})}):m(n)}const ne=Object.freeze(Object.defineProperty({__proto__:null,default:L,frontmatter:P},Symbol.toStringTag,{value:"Module"})),R={title:"Writing an HLD that survives cross-team review",date:"2026-05-17",slug:"hld-cross-team-review",excerpt:"Most high-level design documents are skimmed, signed, and forgotten. The ones that survive are written for specific readers, not a generic reviewer. Here is what changes when you take that seriously.",readTime:"10 min read",tags:["hld","design-docs","cross-team"]};function g(n){const t={a:"a",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The most undervalued artifact in engineering is the high-level design document."}),`
...
`,e.jsx(t.p,{children:"That is the whole craft. Most of the rest is execution."})]})}function N(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(g,{...n})}):g(n)}const se=Object.freeze(Object.defineProperty({__proto__:null,default:N,frontmatter:R},Symbol.toStringTag,{value:"Module"})),F={title:"Human feedback is not a chat message",date:"2026-05-15",slug:"human-feedback-is-not-a-chat-message",excerpt:"In production agent systems, human feedback should be modeled as a structured state transition, not appended to a conversation transcript.",readTime:"10 min read",tags:["agents","human-in-the-loop","architecture"]};function f(n){const t={a:"a",blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"The easiest way to add human feedback to an agent is to append it to the chat."}),`
...
`,e.jsx(t.p,{children:"The good news is the engineering is not exotic. It is the same kind of boundary-design work that has always made the difference between code that works on a happy path and code that works in production. The fact that an LLM sits on one side of the boundary does not change the principles. It just makes the boundary more important."})]})}function B(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(j,{...n})}):j(n)}const ae=Object.freeze(Object.defineProperty({__proto__:null,default:B,frontmatter:H},Symbol.toStringTag,{value:"Module"})),z={title:"What production agents need that demos do not",date:"2026-05-15",slug:"what-production-agents-need",excerpt:"The gap between an impressive agent demo and a trustworthy production system is not model intelligence. It is state, tools, evals, permissions, observability, retries, and human feedback design.",readTime:"11 min read",tags:["agents","production","architecture"]};function y(n){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Agent demos are easy to enjoy."}),`
...
`,e.jsx(t.p,{children:"The future of agents will not be won by the systems with the fanciest demos. It will be won by the systems that make intelligent behavior boring enough to operate."})]})}function V(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(y,{...n})}):y(n)}const oe=Object.freeze(Object.defineProperty({__proto__:null,default:V,frontmatter:z},Symbol.toStringTag,{value:"Module"})),G={title:"Why internal tools feel worse than consumer apps",date:"2026-05-27",slug:"why-internal-tools-feel-worse",excerpt:"Internal tools are often built for delivery, not use. The result is software with real business value, captive users, weak ownership, and a surprising amount of avoidable pain.",readTime:"10 min read",tags:["internal-tools","product-engineering","ui","systems"]};function w(n){const t={a:"a",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.p,{children:"Internal tools are where product taste goes to be negotiated down."}),`
...
`,e.jsx(t.p,{children:"If the tool is important enough to make people use, it is important enough to make usable."})]})}function X(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(w,{...n})}):w(n)}const he=Object.freeze(Object.defineProperty({__proto__:null,default:X,frontmatter:G},Symbol.toStringTag,{value:"Module"}));export{Q as _,K as a,Z as b,ee as c,te as d,ne as e,se as f,ie as g,re as h,ae as i,oe as j,he as k};
