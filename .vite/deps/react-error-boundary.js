...
var ErrorBoundary = class extends import_react.Component {
  ...
  resetErrorBoundary() {
    ...
    if (error !== null) {
      ...
      (_this$props$onReset = (_this$props = this.props).onReset) === null || _this$props$onReset === void 0
        ? void 0
  ...
  componentDidCatch(error, info) {
    ...
    (_this$props$onError = (_this$props2 = this.props).onError) === null || _this$props$onError === void 0
      ? void 0
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (didCatch && prevState.error !== null && hasArrayChanged(prevProps.resetKeys, resetKeys)) {
      ...
      (_this$props$onReset2 = (_this$props3 = this.props).onReset) === null || _this$props$onReset2 === void 0
        ? void 0
