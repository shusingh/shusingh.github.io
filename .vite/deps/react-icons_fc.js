...
function FcAbout(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#2196F3', d: 'M37,40H11l-6,6V12c0-3.3,2.7-6,6-6h26c3.3,0,6,2.7,6,6v22C43,37.3,40.3,40,37,40z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#fff' },
        child: [
          { tag: 'rect', attr: { x: '22', y: '20', width: '4', height: '11' }, child: [] },
...
function FcAcceptDatabase(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#43A047', cx: '38', cy: '38', r: '10' }, child: [] },
      {
        tag: 'polygon',
        attr: { fill: '#DCEDC8', points: '42.5,33.3 36.8,39 34.1,36.3 32,38.5 36.8,43.3 44.6,35.5' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#43A047', cx: '38', cy: '38', r: '10' }, child: [] },
      {
        ...
        attr: { fill: '#fff' },
        child: [
          { tag: 'rect', attr: { x: '36', y: '32', width: '4', height: '12' }, child: [] },
          { tag: 'rect', attr: { x: '32', y: '36', width: '12', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcAddImage(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#B3DDF5', cx: '35', cy: '16', r: '3' }, child: [] },
      { tag: 'polygon', attr: { fill: '#9AC9E3', points: '20,16 9,32 31,32' }, child: [] },
      { tag: 'polygon', attr: { fill: '#B3DDF5', points: '31,22 23,32 39,32' }, child: [] },
      { tag: 'circle', attr: { fill: '#43A047', cx: '38', cy: '38', r: '10' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#fff' },
...
function FcAddressBook(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#673AB7', d: 'M38,44H12V4h26c2.2,0,4,1.8,4,4v32C42,42.2,40.2,44,38,44z' },
        child: [],
      },
      { tag: 'path', attr: { fill: '#311B92', d: 'M10,4h2v40h-2c-2.2,0-4-1.8-4-4V8C6,5.8,7.8,4,10,4z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#fff',
    ...
    child: [
      {
        ...
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'polygon', attr: { points: '46.1,24 33,35 33,13' }, child: [] },
          { tag: 'rect', attr: { x: '10', y: '20', width: '4', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '20', width: '4', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '20', width: '4', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '20', width: '14', height: '8' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#90CAF9' },
        child: [
          { tag: 'path', attr: { d: 'M17.4,33H15v-4h4l0.4,1.5C19.7,31.8,18.7,33,17.4,33z' }, child: [] },
          { tag: 'path', attr: { d: 'M37,36c0,0-11.8-7-18-7V15c5.8,0,18-7,18-7V36z' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#283593' },
        child: [
          { tag: 'circle', attr: { cx: '9', cy: '22', r: '5' }, child: [] },
          { tag: 'path', attr: { d: 'M40,19h-3v6h3c1.7,0,3-1.3,3-3S41.7,19,40,19z' }, child: [] },
          {
            tag: 'path',
            attr: {
      ...
      { tag: 'path', attr: { fill: '#3F51B5', d: 'M9,29h10V15H9c-1.1,0-2,0.9-2,2v10C7,28.1,7.9,29,9,29z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#42A5F5',
...
function FcAlarmClock(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#C62828', cx: '24', cy: '24', r: '20' }, child: [] },
      { tag: 'circle', attr: { fill: '#eee', cx: '24', cy: '24', r: '16' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '19',
      ...
      { tag: 'rect', attr: { x: '23', y: '11', width: '2', height: '13' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '26.1',
      ...
      { tag: 'circle', attr: { cx: '24', cy: '24', r: '2' }, child: [] },
      { tag: 'circle', attr: { fill: '#C62828', cx: '24', cy: '24', r: '1' }, child: [] },
      { tag: 'rect', attr: { x: '22', y: '1', fill: '#37474F', width: '4', height: '3' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#37474F' },
        child: [
          { tag: 'path', attr: { d: 'M44.4,16.2c2.5-3.5,2.1-8.4-1-11.5c-3.1-3.1-8-3.5-11.5-1L44.4,16.2z' }, child: [] },
          { tag: 'path', attr: { d: 'M3.6,16.2c-2.5-3.5-2.1-8.4,1-11.5c3.1-3.1,8-3.5,11.5-1L3.6,16.2z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcAlphabeticalSortingAz(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#546E7A', points: '38,33 38,5 34,5 34,33 28,33 36,43 44,33' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          ...
          { tag: 'path', attr: { d: 'M12.4,40.5H20V43H8.4v-1.9L16,30.3H8.4v-2.5h11.4v1.7L12.4,40.5z' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'path', attr: { d: 'M12.4,17.7H20v2.5H8.4v-1.9L16,7.5H8.4V5h11.4v1.7L12.4,17.7z' }, child: [] },
        ],
      },
      { tag: 'polygon', attr: { fill: '#546E7A', points: '38,33 38,5 34,5 34,33 28,33 36,43 44,33' }, child: [] },
    ],
...
function FcAndroidOs(props) {
  return GenIcon({
    tag: 'svg',
    attr: { version: '1.1', x: '0px', y: '0px', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      {
        tag: 'g',
        attr: {},
        child: [
          ...
          {
            tag: 'path',
            attr: { fill: '#7CB342', d: 'M14,18.001V33c0,1.104,0.896,2,2,2h16c1.104,0,2-0.896,2-2V18.001H14z' },
            child: [],
          },
          {
            tag: 'path',
...
function FcAnswers(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#42A5F5', points: '36,44 8,44 8,8 28,8 36,16' }, child: [] },
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '40,40 12,40 12,4 32,4 40,12' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '38.5,13 31,13 31,5.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#1976D2',
...
function FcApproval(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'polygon',
        attr: { fill: '#CCFF90', points: '34.6,14.6 21,28.2 15.4,22.6 12.6,25.4 21,33.8 37.4,17.4' },
        child: [],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#FFCC80' },
        child: [
          { tag: 'circle', attr: { cx: '38', cy: '26', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '10', cy: '26', r: '4' }, child: [] },
          {
            tag: 'path',
            attr: {
      ...
      {
        tag: 'polygon',
        attr: { fill: '#4CAF50', points: '32.6,18.6 22.3,28.9 17.4,24 14.6,26.8 22.3,34.5 35.4,21.4' },
        child: [],
      },
    ],
  })(props);
...
function FcAreaChart(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '42,37 6,37 6,25 16,10 30,17 42,6' }, child: [] },
      { tag: 'polygon', attr: { fill: '#00BCD4', points: '42,42 6,42 6,32 16,24 30,26 42,17' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#784719' },
        child: [
          { tag: 'circle', attr: { cx: '31', cy: '26', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '17', cy: '26', r: '2' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '24', cy: '38', r: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcAudioFile(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '204', fill: 'none', width: '48', height: '48' }, child: [] },
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '244,45 212,45 212,3 234,3 244,13' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '242.5,14 233,14 233,4.5' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'circle', attr: { cx: '227', cy: '30', r: '4' }, child: [] },
          { tag: 'polygon', attr: { points: '234,21 229,19 229,30 231,30 231,22.9 234,24' }, child: [] },
        ],
      },
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '40,45 8,45 8,3 30,3 40,13' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '38.5,14 29,14 29,4.5' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'circle', attr: { cx: '23', cy: '30', r: '4' }, child: [] },
          { tag: 'polygon', attr: { points: '30,21 25,19 25,30 27,30 27,22.9 30,24' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'circle', attr: { cx: '35', cy: '37', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '13', cy: '37', r: '5' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      },
      {
        ...
        attr: { fill: '#546E7A' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '37', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '35', cy: '37', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '13', cy: '37', r: '2' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcBadDecision(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '16', y: '24', fill: '#F44336', width: '16', height: '4' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'rect', attr: { x: '19', y: '22', width: '10', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '12', width: '10', height: '30' }, child: [] },
          { tag: 'rect', attr: { x: '32', y: '6', width: '10', height: '36' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcBbc(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#37474F', d: 'M0,17v14h14V17H0z M34,17v14h14V17H34z M17,17v14h14V17H17z' },
        child: [],
      },
      {
        tag: 'path',
    ...
    child: [
      {
        ...
        attr: { fill: '#F44336' },
        child: [
          { tag: 'rect', attr: { x: '40', y: '34', width: '4', height: '10' }, child: [] },
          { tag: 'rect', attr: { x: '34', y: '29', width: '4', height: '15' }, child: [] },
          { tag: 'rect', attr: { x: '28', y: '33', width: '4', height: '11' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '25', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '28', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '10', y: '24', width: '4', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '19', width: '4', height: '25' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          {
            ...
            attr: {
              points:
                '34,13.2 30,17.2 20,7.2 15,12.2 7.4,4.6 4.6,7.4 15,17.8 20,12.8 30,22.8 34,18.8 40.1,24.9 42.9,22.1',
            },
            child: [],
          },
          { tag: 'polygon', attr: { points: '44,26 35,26 44,17' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'circle', attr: { cx: '33', cy: '16', r: '6' }, child: [] },
          { tag: 'circle', attr: { cx: '15', cy: '16', r: '6' }, child: [] },
          {
            tag: 'path',
            attr: {
          ...
          { tag: 'circle', attr: { cx: '38', cy: '30', r: '10' }, child: [] },
          { tag: 'circle', attr: { cx: '10', cy: '30', r: '10' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '28', r: '5' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#546E7A', cx: '24', cy: '28', r: '2' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#a0f' },
        child: [
          { tag: 'circle', attr: { cx: '38', cy: '30', r: '7' }, child: [] },
          { tag: 'circle', attr: { cx: '10', cy: '30', r: '7' }, child: [] },
        ],
      },
      {
        tag: 'g',
...
function FcBiomass(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#9CCC65', d: 'M32,15V7H16v8L6.2,40c-0.6,1.5,0.5,3,2.1,3h31.5c1.6,0,2.6-1.6,2.1-3L32,15z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#2E7D32', d: 'M28,30c0,4.4-4,8-4,8s-4-3.6-4-8s4-8,4-8S28,25.6,28,30z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#388E3C', d: 'M31.1,32.6c-2,4-7.1,5.4-7.1,5.4s-2-5,0-8.9s7.1-5.4,7.1-5.4S33.1,28.6,31.1,32.6z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#43A047', d: 'M16.9,32.6c2,4,7.1,5.4,7.1,5.4s2-5,0-8.9s-7.1-5.4-7.1-5.4S14.9,28.6,16.9,32.6z' },
        child: [],
      },
    ],
  })(props);
...
function FcBiotech(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#AD1457', d: 'M38,41H11c-0.6,0-1-0.4-1-1s0.4-1,1-1h27c0.6,0,1,0.4,1,1S38.6,41,38,41z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#AD1457', d: 'M36,37H12c-0.6,0-1-0.4-1-1s0.4-1,1-1h24c0.6,0,1,0.4,1,1S36.6,37,36,37z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#AD1457', d: 'M34,33H14c-0.6,0-1-0.4-1-1s0.4-1,1-1h20c0.6,0,1,0.4,1,1S34.6,33,34,33z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#AD1457', d: 'M29,29H19c-0.6,0-1-0.4-1-1s0.4-1,1-1h10c0.6,0,1,0.4,1,1S29.6,29,29,29z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#E91E63', d: 'M37,9H10C9.4,9,9,8.6,9,8s0.4-1,1-1h27c0.6,0,1,0.4,1,1S37.6,9,37,9z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#E91E63', d: 'M36,13H12c-0.6,0-1-0.4-1-1s0.4-1,1-1h24c0.6,0,1,0.4,1,1S36.6,13,36,13z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#E91E63', d: 'M34,17H14c-0.6,0-1-0.4-1-1s0.4-1,1-1h20c0.6,0,1,0.4,1,1S34.6,17,34,17z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#E91E63', d: 'M29,21H19c-0.6,0-1-0.4-1-1s0.4-1,1-1h10c0.6,0,1,0.4,1,1S29.6,21,29,21z' },
        child: [],
      },
      {
        tag: 'path',
...
function FcBookmark(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#F44336', d: 'M37,43l-13-6l-13,6V9c0-2.2,1.8-4,4-4h18c2.2,0,4,1.8,4,4V43z' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'polygon', attr: { points: '19.5,4 16,6 22.1,14.1 23.4,13.3' }, child: [] },
          { tag: 'polygon', attr: { points: '28.5,4 32,6 25.9,14.1 24.6,13.3' }, child: [] },
          { tag: 'polygon', attr: { points: '28.5,44 32,42 25.9,33.9 24.6,34.7' }, child: [] },
          { tag: 'polygon', attr: { points: '19.5,44 16,42 22.1,33.9 23.4,34.7' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#4CAF50' },
        child: [
          { tag: 'rect', attr: { x: '40', y: '21', width: '4', height: '23' }, child: [] },
          { tag: 'rect', attr: { x: '34', y: '28', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '28', y: '23', width: '4', height: '21' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '29', width: '4', height: '15' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '32', width: '4', height: '12' }, child: [] },
          { tag: 'rect', attr: { x: '10', y: '30', width: '4', height: '14' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '34', width: '4', height: '10' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          {
            ...
            attr: {
              points:
                '40.1,9.1 34,15.2 30,11.2 20,21.2 15,16.2 4.6,26.6 7.4,29.4 15,21.8 20,26.8 30,16.8 34,20.8 42.9,11.9',
            },
            child: [],
          },
          { tag: 'polygon', attr: { points: '44,8 35,8 44,17' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'path', attr: { d: 'M31,28c0,0-1.9-4-7-4c-5.1,0-7,4-7,4v2h14V28z' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#263238' },
        child: [
          { tag: 'path', attr: { d: 'M11,44H9c-0.6,0-1-0.4-1-1v-2h4v2C12,43.6,11.6,44,11,44z' }, child: [] },
          { tag: 'path', attr: { d: 'M39,44h-2c-0.6,0-1-0.4-1-1v-2h4v2C40,43.6,39.6,44,39,44z' }, child: [] },
        ],
      },
      {
        tag: 'path',
...
function FcBusinessman(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#FF9800', points: '24,37 19,31 19,25 29,25 29,31' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFA726' },
        child: [
          { tag: 'circle', attr: { cx: '33', cy: '19', r: '2' }, child: [] },
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '20', cy: '19', r: '1' }, child: [] },
        ],
      },
      { tag: 'polygon', attr: { fill: '#fff', points: '24,43 19,31 24,32 29,31' }, child: [] },
      {
        tag: 'polygon',
        attr: { fill: '#D32F2F', points: '23,35 22.3,39.5 24,43.5 25.7,39.5 25,35 26,34 24,32 22,34' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#546E7A', d: 'M29,31L29,31l-5,12l-5-12c0,0-11,2-11,13h32C40,33,29,31,29,31z' },
        child: [],
      },
    ],
  })(props);
...
function FcBusinesswoman(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '16', y: '15', fill: '#BF360C', width: '16', height: '18' }, child: [] },
      { tag: 'path', attr: { fill: '#78909C', d: 'M40,44H8c0-11,11-13,11-13h10C29,31,40,33,40,44z' }, child: [] },
      { tag: 'path', attr: { fill: '#FF9800', d: 'M24,37c-2.2,0-5-6-5-6v-6h10v6C29,31,26.2,37,24,37z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FFB74D',
      ...
      {
        tag: 'path',
        attr: { fill: '#FF5722', d: 'M24,4C17.9,4,9,7.4,9,27.3l7,4.7V19l12-7l4,5v15l7-6c0-4-0.7-20-11-20l-1-2H24z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#FFB74D', d: 'M24,38c-4.4,0-5-7-5-7s2.5,4,5,4s5-4,5-4S28.4,38,24,38z' },
        child: [],
      },
      { tag: 'circle', attr: { fill: '#784719', cx: '28', cy: '21', r: '1' }, child: [] },
      { tag: 'circle', attr: { fill: '#784719', cx: '20', cy: '21', r: '1' }, child: [] },
    ],
  })(props);
}
function FcButtingIn(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#37474F', d: 'M25,3.1v41.9c4.1-0.2,7.9-1.5,11-3.7V6.8C32.9,4.6,29.1,3.2,25,3.1z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#FFB74D', d: 'M29,38.6L25,38v-9h8l-0.7,7C32.1,37.6,30.7,38.8,29,38.6z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#FFB74D', points: '39,29 32,31 31,26 32,22' }, child: [] },
      { tag: 'circle', attr: { fill: '#784719', cx: '29.5', cy: '25.5', r: '1.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF5722',
      ...
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '19', cy: '27', r: '3' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#CFD8DC', d: 'M45,24c0-7.1-3.6-13.4-9-17.2v34.4C41.4,37.4,45,31.1,45,24z' },
        child: [],
      },
      {
        tag: 'path',
...
function FcCableRelease(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#B3E5FC', cx: '28', cy: '11', r: '4' }, child: [] },
    ],
  })(props);
}
function FcCalculator(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#616161', d: 'M40,16H8v24c0,2.2,1.8,4,4,4h24c2.2,0,4-1.8,4-4V16z' }, child: [] },
      { tag: 'path', attr: { fill: '#424242', d: 'M36,4H12C9.8,4,8,5.8,8,8v9h32V8C40,5.8,38.2,4,36,4z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#9CCC65',
      ...
      },
      {
        ...
        attr: { fill: '#33691E' },
        child: [
          { tag: 'rect', attr: { x: '33', y: '10', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '29', y: '10', width: '2', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'path',
...
function FcCalendar(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#CFD8DC', d: 'M5,38V14h38v24c0,2.2-1.8,4-4,4H9C6.8,42,5,40.2,5,38z' }, child: [] },
      { tag: 'path', attr: { fill: '#F44336', d: 'M43,10v6H5v-6c0-2.2,1.8-4,4-4h30C41.2,6,43,7.8,43,10z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#B71C1C' },
        child: [
          { tag: 'circle', attr: { cx: '33', cy: '10', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '15', cy: '10', r: '3' }, child: [] },
        ],
      },
      {
        tag: 'g',
      ...
      },
      {
        ...
        attr: { fill: '#90A4AE' },
        child: [
          { tag: 'rect', attr: { x: '13', y: '20', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '20', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '25', y: '20', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '20', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '26', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '26', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '25', y: '26', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '26', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '32', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '32', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '25', y: '32', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '32', width: '4', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'polygon', attr: { points: '25.3,18.6 30.7,24 25.3,29.4' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '22', width: '11', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'path', attr: { d: 'M35,9H25v4h10c1.1,0,2,0.9,2,2v10h4V15C41,11.7,38.3,9,35,9z' }, child: [] },
          { tag: 'polygon', attr: { points: '28,16 21.3,11 28,6' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcCamcorderPro(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '27', y: '8', fill: '#37474F', width: '10', height: '4' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#607D8B',
      ...
      { tag: 'path', attr: { fill: '#607D8B', d: 'M38,35l5,5h3V18h-3l-5,5V35z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#546E7A',
      ...
      { tag: 'rect', attr: { x: '34', y: '23', fill: '#455A64', width: '4', height: '12' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#263238',
      ...
      { tag: 'rect', attr: { x: '8', y: '23', fill: '#03A9F4', width: '14', height: '10' }, child: [] },
      { tag: 'polygon', attr: { fill: '#4FC3F7', points: '13.5,25.5 9,32 18,32' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#B3E5FC' },
        child: [
          { tag: 'circle', attr: { cx: '19.5', cy: '25.5', r: '1.5' }, child: [] },
          { tag: 'polygon', attr: { points: '17.5,27.6 14,32 21,32' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcCamcorder(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#455A64', cx: '15', cy: '15', r: '7' }, child: [] },
      { tag: 'circle', attr: { fill: '#42A5F5', cx: '15', cy: '15', r: '5.2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90CAF9',
      ...
      { tag: 'rect', attr: { x: '24', y: '19', fill: '#455A64', width: '2', height: '10' }, child: [] },
      { tag: 'rect', attr: { x: '28', y: '19', fill: '#03A9F4', width: '12', height: '10' }, child: [] },
      { tag: 'polygon', attr: { fill: '#4FC3F7', points: '33,22.2 29,28 37,28' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#B3E5FC' },
        child: [
          { tag: 'circle', attr: { cx: '37.5', cy: '21.5', r: '1' }, child: [] },
          { tag: 'polygon', attr: { points: '36,24.2 33,28 39,28' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#455A64', cx: '15', cy: '35', r: '3' }, child: [] },
      { tag: 'circle', attr: { fill: '#F44336', cx: '15', cy: '35', r: '2' }, child: [] },
    ],
  })(props);
}
function FcCameraAddon(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#8667C4', d: 'M14,11H8V9.2C8,8.5,8.5,8,9.2,8h3.6C13.5,8,14,8.5,14,9.2V11z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'circle', attr: { fill: '#512DA8', cx: '24', cy: '26', r: '12' }, child: [] },
      { tag: 'circle', attr: { fill: '#B388FF', cx: '24', cy: '26', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#C7A7FF',
      ...
      { tag: 'ellipse', attr: { fill: '#8667C4', cx: '11', cy: '13.5', rx: '2', ry: '1.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#8BC34A',
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#B388FF', cx: '24', cy: '26', r: '9' }, child: [] },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '35', cy: '35', r: '10' }, child: [] },
        ],
      },
      {
        tag: 'rect',
      ...
      { tag: 'circle', attr: { fill: '#64B5F6', cx: '35', cy: '35', r: '8' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#BBDEFB',
    ...
    child: [
      {
        ...
        attr: { fill: '#546E7A' },
        child: [
          { tag: 'rect', attr: { x: '38', y: '4', width: '2', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '7', width: '2', height: '17' }, child: [] },
          { tag: 'rect', attr: { x: '8', y: '27', width: '2', height: '17' }, child: [] },
          { tag: 'rect', attr: { x: '28', y: '19', width: '2', height: '22' }, child: [] },
        ],
      },
      {
        tag: 'path',
    ...
    child: [
      {
        ...
        attr: { fill: '#FF9800' },
        child: [
          { tag: 'rect', attr: { y: '27', width: '25', height: '4' }, child: [] },
          { tag: 'rect', attr: { y: '17', width: '25', height: '4' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'path', attr: { d: 'M46,35c1.1,0,2-0.9,2-2V15c0-1.1-0.9-2-2-2H27v22H46z' }, child: [] },
          { tag: 'path', attr: { d: 'M21,13c-1.1,0-2,0.9-2,2v18c0,1.1,0.9,2,2,2h2V13H21z' }, child: [] },
        ],
      },
      {
        tag: 'path',
        ...
        child: [
          {
            ...
            attr: {
              fill: '#0D47A1',
              points:
                '45.799,15.98 46.9,15.98 46.9,12.881 48,12.881 48,11.98 44.799,11.98 44.799,12.881 \r\n		45.799,12.881 	',
            },
            child: [],
          },
          {
          ...
          },
          {
            ...
            attr: {
              fill: '#0D47A1',
              points:
                '29.516,12 28.717,14.9 27.816,12 26.217,12 26.217,16 27.316,16 27.316,13 28.115,16 29.217,16 \r\n		30.115,13.1 30.115,16 31.115,16 31.115,12 	',
            },
            child: [],
          },
          {
...
function FcCellPhone(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#546E7A', d: 'M12,40V10h20c2.2,0,4,1.8,4,4v26c0,2.2-1.8,4-4,4H16C13.8,44,12,42.2,12,40z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'path', attr: { fill: '#37474F', d: 'M16,10h-4V4c0-1.1,0.9-2,2-2h0c1.1,0,2,0.9,2,2V10z' }, child: [] },
    ],
  })(props);
}
function FcChargeBattery(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#FFEB3B', points: '30,24 24.5,24 26.7,13 18,26 23.5,26 21.3,37' }, child: [] },
    ],
  })(props);
}
...
function FcClapperboard(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M40,41H8c-2.2,0-4-1.8-4-4V15h40v22C44,39.2,42.2,41,40,41z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#9FA8DA' },
        child: [
          { tag: 'polygon', attr: { points: '18.8,6.4 23.7,11.7 27.7,11 22.7,5.7' }, child: [] },
          { tag: 'polygon', attr: { points: '10.9,7.7 15.8,13 19.8,12.3 14.8,7.1' }, child: [] },
          { tag: 'polygon', attr: { points: '26.7,5.1 31.6,10.3 35.5,9.7 30.6,4.4' }, child: [] },
          { tag: 'polygon', attr: { points: '34.5,3.8 39.5,9 43.4,8.3 38.5,3.1' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#9FA8DA', cx: '7.5', cy: '11.5', r: '1.5' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#9FA8DA' },
        child: [
          { tag: 'polygon', attr: { points: '40,15 36,21 40,21 44,15' }, child: [] },
          { tag: 'polygon', attr: { points: '32,15 28,21 32,21 36,15' }, child: [] },
          { tag: 'polygon', attr: { points: '24,15 20,21 24,21 28,15' }, child: [] },
          { tag: 'polygon', attr: { points: '16,15 12,21 16,21 20,15' }, child: [] },
          { tag: 'polygon', attr: { points: '8,15 4,21 8,21 12,15' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcClearFilters(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#F57C00', points: '29,23 19,23 7,9 41,9' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FF9800' },
        child: [
          { tag: 'polygon', attr: { points: '29,38 19,44 19,23 29,23' }, child: [] },
          {
            tag: 'path',
            attr: {
      ...
      { tag: 'circle', attr: { fill: '#F44336', cx: '38', cy: '38', r: '10' }, child: [] },
      { tag: 'rect', attr: { x: '32', y: '36', fill: '#fff', width: '12', height: '4' }, child: [] },
    ],
  })(props);
}
function FcClock(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#00ACC1', cx: '24', cy: '24', r: '20' }, child: [] },
      { tag: 'circle', attr: { fill: '#eee', cx: '24', cy: '24', r: '16' }, child: [] },
      { tag: 'rect', attr: { x: '23', y: '11', width: '2', height: '13' }, child: [] },
      {
        tag: 'rect',
      ...
      { tag: 'circle', attr: { cx: '24', cy: '24', r: '2' }, child: [] },
      { tag: 'circle', attr: { fill: '#00ACC1', cx: '24', cy: '24', r: '1' }, child: [] },
    ],
  })(props);
}
function FcCloseUpMode(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#2E7D32', d: 'M5,24c0,18.9,14.8,19,17,19s4,0,4,0S24.1,26.5,5,24z' }, child: [] },
      { tag: 'rect', attr: { x: '22', y: '26', fill: '#388E3C', width: '4', height: '17' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#C62828', d: 'M34,16c0,5.1-5.2,8.2-8,8.2s-2-3.1-2-8.2s5-9.2,5-9.2S34,10.9,34,16z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#C62828', d: 'M14,16c0,5.1,5.2,8.2,8,8.2s2-3.1,2-8.2s-5-9.2-5-9.2S14,10.9,14,16z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#F44336', d: 'M30,16c0,6.1-2.7,11-6,11s-6-4.9-6-11s6-11,6-11S30,9.9,30,16z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#4CAF50', d: 'M22,43c0,0,1.8,0,4,0s17-0.1,17-19C23.9,26.5,22,43,22,43z' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#BF360C' },
        child: [
          { tag: 'rect', attr: { x: '6', y: '35', width: '36', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '31', width: '36', height: '2' }, child: [] },
          { tag: 'path', attr: { d: 'M6.1,39c0.2,0.8,0.6,1.5,1.2,2h33.2c0.6-0.5,1-1.2,1.2-2H6.1z' }, child: [] },
          { tag: 'path', attr: { d: 'M6.1,9h35.7c-0.2-0.8-0.6-1.5-1.2-2H7.4C6.8,7.5,6.3,8.2,6.1,9z' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '23', width: '36', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '27', width: '36', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '15', width: '36', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '11', width: '36', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '19', width: '36', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#FF8A65' },
        child: [
          { tag: 'rect', attr: { x: '27', y: '6', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '27', y: '13', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '27', y: '29', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '6', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '29', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '9', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '6', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '25', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '9', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '21', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '17', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '33', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '27', y: '21', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '39', y: '33', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '39', y: '17', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '39', y: '25', width: '2', height: '6' }, child: [] },
          { tag: 'path', attr: { d: 'M39,6.1V7h1.6C40.2,6.6,39.6,6.3,39,6.1z' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '17', width: '2', height: '6' }, child: [] },
          { tag: 'path', attr: { d: 'M40.6,41H39v0.9C39.6,41.7,40.2,41.4,40.6,41z' }, child: [] },
          { tag: 'rect', attr: { x: '35', y: '13', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '33', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '35', y: '29', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '39', y: '9', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '35', y: '21', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '25', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '35', y: '37', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '35', y: '6', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '41', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '23', y: '41', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '27', y: '37', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '37', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '17', width: '2', height: '6' }, child: [] },
          { tag: 'path', attr: { d: 'M9,41H7.4c0.5,0.4,1,0.7,1.6,0.9V41z' }, child: [] },
          { tag: 'path', attr: { d: 'M7.4,7H9V6.1C8.4,6.3,7.8,6.6,7.4,7z' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '33', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '25', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '9', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '29', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '17', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '33', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '9', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '6', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '6', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '25', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '41', width: '2', height: '1' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '21', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '6', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '37', width: '2', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '13', width: '2', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '13', width: '2', height: '6' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcCollaboration(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#1565C0', d: 'M25,22h13l6,6V11c0-2.2-1.8-4-4-4H25c-2.2,0-4,1.8-4,4v7C21,20.2,22.8,22,25,22z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#2196F3', d: 'M23,19H10l-6,6V8c0-2.2,1.8-4,4-4h15c2.2,0,4,1.8,4,4v7C27,17.2,25.2,19,23,19z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#FFA726' },
        child: [
          { tag: 'circle', attr: { cx: '12', cy: '31', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '36', cy: '31', r: '5' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#607D8B' },
        child: [
          { tag: 'path', attr: { d: 'M20,42c0,0-2.2-4-8-4s-8,4-8,4v2h16V42z' }, child: [] },
          { tag: 'path', attr: { d: 'M44,42c0,0-2.2-4-8-4s-8,4-8,4v2h16V42z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcCollapse(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#2196F3', points: '5,30.9 8.1,34 24,18.1 39.9,34 43,30.9 24,12' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#009688' },
        child: [
          { tag: 'rect', attr: { x: '22', y: '35', width: '4', height: '11' }, child: [] },
          { tag: 'polygon', attr: { points: '24,29.6 31,38 17,38' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#009688' },
        child: [
          { tag: 'rect', attr: { x: '22', y: '2', width: '4', height: '11' }, child: [] },
          { tag: 'polygon', attr: { points: '24,18.4 17,10 31,10' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#009688' },
        child: [
          { tag: 'rect', attr: { x: '2', y: '22', width: '11', height: '4' }, child: [] },
          { tag: 'polygon', attr: { points: '18.4,24 10,31 10,17' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#009688' },
        child: [
          { tag: 'rect', attr: { x: '35', y: '22', width: '11', height: '4' }, child: [] },
          { tag: 'polygon', attr: { points: '29.6,24 38,17 38,31' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#F44336', cx: '24', cy: '24', r: '3' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'rect', attr: { x: '37', y: '18', width: '6', height: '24' }, child: [] },
          { tag: 'rect', attr: { x: '29', y: '26', width: '6', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '22', width: '6', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '32', width: '6', height: '10' }, child: [] },
          { tag: 'rect', attr: { x: '5', y: '28', width: '6', height: '14' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'circle', attr: { cx: '8', cy: '16', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '16', cy: '18', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '11', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '13', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '40', cy: '9', r: '3' }, child: [] },
          {
            tag: 'polygon',
            attr: {
    ...
    child: [
      {
        ...
        child: [
          {
            tag: 'path',
            attr: { fill: '#CFD8DC', d: 'M41,6H7C6.4,6,6,6.4,6,7v35h36V7C42,6.4,41.6,6,41,6z' },
            child: [],
          },
        ],
      },
      { tag: 'rect', attr: { x: '8', y: '13', fill: '#263238', width: '32', height: '27' }, child: [] },
      {
        tag: 'g',
        attr: {},
        child: [
          ...
          { tag: 'path', attr: { fill: '#76FF03', d: 'M28,21h2l3,10h-2L28,21z' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: {},
        child: [
          { tag: 'circle', attr: { fill: '#90A4AE', cx: '13.5', cy: '9.5', r: '1.5' }, child: [] },
          { tag: 'circle', attr: { fill: '#90A4AE', cx: '9.5', cy: '9.5', r: '1.5' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcComments(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M37,39H11l-6,6V11c0-3.3,2.7-6,6-6h26c3.3,0,6,2.7,6,6v22C43,36.3,40.3,39,37,39z' },
        child: [],
      },
    ],
  })(props);
...
function FcCompactCamera(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#455A64', cx: '29', cy: '24', r: '12' }, child: [] },
      { tag: 'circle', attr: { fill: '#42A5F5', cx: '29', cy: '24', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90CAF9',
      ...
      { tag: 'rect', attr: { x: '8', y: '13', fill: '#ADD8FB', width: '6', height: '3' }, child: [] },
    ],
  })(props);
}
function FcConferenceCall(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#FFA726', cx: '12', cy: '21', r: '5' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#455A64' },
        child: [
          { tag: 'path', attr: { d: 'M2,34.7c0,0,2.8-6.3,10-6.3s10,6.3,10,6.3V38H2V34.7z' }, child: [] },
          { tag: 'path', attr: { d: 'M46,34.7c0,0-2.8-6.3-10-6.3s-10,6.3-10,6.3V38h20V34.7z' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '24', cy: '17', r: '6' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#607D8B', d: 'M36,34.1c0,0-3.3-7.5-12-7.5s-12,7.5-12,7.5V38h24V34.1z' },
        child: [],
      },
      { tag: 'circle', attr: { fill: '#FFA726', cx: '36', cy: '21', r: '5' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFA726', cx: '12', cy: '21', r: '5' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFA726', cx: '36', cy: '21', r: '5' }, child: [] },
    ],
  })(props);
...
function FcContacts(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#FF7043', d: 'M38,44H12V4h26c2.2,0,4,1.8,4,4v32C42,42.2,40.2,44,38,44z' },
        child: [],
      },
      { tag: 'path', attr: { fill: '#BF360C', d: 'M10,4h2v40h-2c-2.2,0-4-1.8-4-4V8C6,5.8,7.8,4,10,4z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#AB300B' },
        child: [
          { tag: 'circle', attr: { cx: '26', cy: '20', r: '4' }, child: [] },
          { tag: 'path', attr: { d: 'M33,30c0,0-1.9-4-7-4c-5.1,0-7,4-7,4v2h14V30z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcCopyleft(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#9C27B0', cx: '24', cy: '24', r: '21' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#E1BEE7',
    ...
    child: [
      {
        ...
        attr: { fill: '#FF9800' },
        child: [
          { tag: 'rect', attr: { x: '3', y: '28', width: '26', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '3', y: '16', width: '26', height: '4' }, child: [] },
        ],
      },
      {
        tag: 'path',
        attr: { fill: '#2196F3', d: 'M43,11H20v26h23c1.1,0,2-0.9,2-2V13C45,11.9,44.1,11,43,11z' },
        child: [],
      },
      { tag: 'path', attr: { fill: '#64B5F6', d: 'M20,9h-2v30h2c1.1,0,2-0.9,2-2V11C22,9.9,21.1,9,20,9z' }, child: [] },
    ],
  })(props);
}
function FcCurrencyExchange(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#3F51B5', cx: '18', cy: '18', r: '15' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FFF59D',
      ...
      { tag: 'circle', attr: { fill: '#4CAF50', cx: '30', cy: '30', r: '15' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#fff',
...
function FcCustomerSupport(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#FF9800', points: '29,43 29,38.4 22,37 22,43' }, child: [] },
      { tag: 'circle', attr: { fill: '#784719', cx: '33.5', cy: '21.5', r: '1.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF5722',
      ...
      { tag: 'circle', attr: { fill: '#37474F', cx: '37', cy: '33', r: '2' }, child: [] },
      { tag: 'circle', attr: { fill: '#37474F', cx: '21', cy: '23', r: '7' }, child: [] },
      { tag: 'circle', attr: { fill: '#546E7A', cx: '21', cy: '23', r: '4' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#81D4FA' },
        child: [
          { tag: 'rect', attr: { x: '24', y: '28', width: '18', height: '14' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '10', width: '12', height: '32' }, child: [] },
        ],
      },
      {
        tag: 'g',
      ...
      { tag: 'path', attr: { fill: '#455A64', d: 'M25.1,9.2L31.5,42H18V6h3.2C23.1,6,24.8,7.4,25.1,9.2z' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'polygon', attr: { points: '31,30 38,35.6 38,24.4' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcDataEncryption(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '39', y: '37.1', fill: '#D68600', width: '1', height: '10.9' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#F44336' },
        child: [
          { tag: 'rect', attr: { x: '35', y: '28', width: '6', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '28', y: '35', width: '20', height: '6' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcDataSheet(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#00BCD4', points: '40,8 8,8 8,40 16,40 16,16 40,16' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#0097A7',
...
function FcDebt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#FFB74D', d: 'M10,12c-2.8,0-5-2.2-5-5s2.2-5,5-5s5,2.2,5,5S12.8,12,10,12z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#607D8B', d: 'M2,22v8l3,2l1,14h8l1-14l3-2v-8c0-4.4-3.6-8-8-8h0C5.6,14,2,17.6,2,22z' },
        child: [],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '14.4,40 10,40 10,44 14.1,44' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#4CAF50', cx: '36', cy: '36', r: '10' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#fff',
...
function FcDepartment(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#C5CAE9', points: '42,42 6,42 6,9 24,2 42,9' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '42', fill: '#9FA8DA', width: '36', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '20', y: '35', fill: '#BF360C', width: '8', height: '9' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'rect', attr: { x: '31', y: '27', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '27', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '27', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '35', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '35', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '19', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '19', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '19', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '11', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '11', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '11', width: '6', height: '5' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcDeployment(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#B0BEC5', d: 'M37,42H5V32h32c2.8,0,5,2.2,5,5v0C42,39.8,39.8,42,37,42z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#607D8B', d: 'M37,31H5v2h32c2.2,0,4,1.8,4,4s-1.8,4-4,4H5v2h32c3.3,0,6-2.7,6-6S40.3,31,37,31z' },
        child: [],
      },
    ],
  })(props);
...
function FcDiploma1(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '4', y: '9', fill: '#E8EAF6', width: '40', height: '30' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#5C6BC0' },
        child: [
          { tag: 'polygon', attr: { points: '30,34 32.8,34 27.8,29 25,31.8 30,36.8' }, child: [] },
          { tag: 'polygon', attr: { points: '18,34 15.2,34 20.2,29 23,31.8 18,36.8' }, child: [] },
        ],
      },
      { tag: 'rect', attr: { x: '11', y: '15', fill: '#9FA8DA', width: '26', height: '4' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#9FA8DA',
...
function FcDiploma2(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '9', y: '4', fill: '#FBE9E7', width: '30', height: '40' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#F4511E' },
        child: [
          { tag: 'polygon', attr: { points: '30,37 32.8,37 27.8,32 25,34.8 30,39.8' }, child: [] },
          { tag: 'polygon', attr: { points: '18,37 15.2,37 20.2,32 23,34.8 18,39.8' }, child: [] },
        ],
      },
      { tag: 'rect', attr: { x: '15', y: '13', fill: '#FF8A65', width: '18', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '15', y: '20', fill: '#FF8A65', width: '18', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF8A65',
    ...
    child: [
      {
        ...
        attr: { fill: '#FFCC80' },
        child: [
          { tag: 'path', attr: { d: 'M13,22H8v-8.5c0-1.4,1.1-2.5,2.5-2.5h0c1.4,0,2.5,1.1,2.5,2.5V22z' }, child: [] },
          { tag: 'path', attr: { d: 'M20,22h-5V7.5C15,6.1,16.1,5,17.5,5h0C18.9,5,20,6.1,20,7.5V22z' }, child: [] },
          { tag: 'path', attr: { d: 'M27,22h-5V5.5C22,4.1,23.1,3,24.5,3h0C25.9,3,27,4.1,27,5.5V22z' }, child: [] },
          { tag: 'path', attr: { d: 'M34,22h-5V8.5C29,7.1,30.1,6,31.5,6h0C32.9,6,34,7.1,34,8.5V22z' }, child: [] },
          {
            tag: 'path',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#2962FF' },
        child: [
          { tag: 'polygon', attr: { points: '36,17 31,17 29,15 31,13 36,13 38,15' }, child: [] },
          { tag: 'polygon', attr: { points: '36,35 31,35 29,33 31,31 36,31 38,33' }, child: [] },
          { tag: 'polygon', attr: { points: '37,30 37,18 39,16 41,18 41,30 39,32' }, child: [] },
          { tag: 'polygon', attr: { points: '26,30 26,18 28,16 30,18 30,30 28,32' }, child: [] },
          { tag: 'polygon', attr: { points: '17,17 12,17 10,15 12,13 17,13 19,15' }, child: [] },
          { tag: 'polygon', attr: { points: '17,35 12,35 10,33 12,31 17,31 19,33' }, child: [] },
          { tag: 'polygon', attr: { points: '18,30 18,18 20,16 22,18 22,30 20,32' }, child: [] },
          { tag: 'polygon', attr: { points: '7,30 7,18 9,16 11,18 11,30 9,32' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcDoNotInhale(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#CC861E', d: 'M23,34c-3.3,0-6.4-3.1-8-4c0,0,0.7,0,1.8,0C19.9,30,21.3,34,23,34z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#CC861E', d: 'M25,34c3.3,0,6.4-3.1,8-4c0,0-0.7,0-1.8,0C28.1,30,26.7,34,25,34z' },
        child: [],
      },
      {
        tag: 'rect',
      ...
      },
      {
        ...
        attr: { fill: '#FF5722' },
        child: [
          { tag: 'polygon', attr: { points: '18,35 22,39 14,39' }, child: [] },
          { tag: 'rect', attr: { x: '17', y: '38', width: '2', height: '4' }, child: [] },
          { tag: 'polygon', attr: { points: '30,35 34,39 26,39' }, child: [] },
          { tag: 'rect', attr: { x: '29', y: '38', width: '2', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#7CB342' },
        child: [
          { tag: 'polygon', attr: { points: '31,29 24,36 17,29' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '7', width: '4', height: '25' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcDoNotMix(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#00BCD4', points: '26.9,42 17,42 17,32.1' }, child: [] },
      { tag: 'polygon', attr: { fill: '#00BCD4', points: '30,6 30,26.2 19.8,36.4 22.6,39.2 34,27.8 34,6' }, child: [] },
      { tag: 'polygon', attr: { fill: '#2196F3', points: '15.9,31 6,31 6,21.1' }, child: [] },
      {
        tag: 'polygon',
        attr: { fill: '#2196F3', points: '20.2,14 8.8,25.4 11.6,28.2 21.8,18 41,18 41,14' },
        child: [],
      },
      {
        tag: 'rect',
  ...
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '38.5,14 29,14 29,4.5' }, child: [] },
      {
        ...
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'rect', attr: { x: '16', y: '21', width: '17', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '25', width: '13', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '29', width: '17', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '33', width: '13', height: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcDonate(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'polygon',
        attr: { fill: '#E69329', points: '11.7,21.6 16.8,31.5 26.3,27.6 30.7,14.9 15.9,15.7' },
        child: [],
      },
      { tag: 'circle', attr: { fill: '#546E7A', cx: '15', cy: '36', r: '7.8' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#90A4AE' },
        child: [
          ...
          { tag: 'rect', attr: { x: '14', y: '33', width: '2', height: '8' }, child: [] },
        ],
      },
      {
        tag: 'g',
...
function FcDoughnutChart(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#448AFF', d: 'M30,24h13c0-10.5-8.5-19-19-19v13C27.3,18,30,20.7,30,24z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M43,24H30c0,1.9-0.9,3.6-2.3,4.7l8,10.2C40.2,35.4,43,30,43,24z' },
        child: [],
      },
    ],
  })(props);
...
function FcDownLeft(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '4,29 18,17.3 18,40.7' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M42,21V8h-8v13c0,2.2-1.8,4-4,4H13v8h17C36.6,33,42,27.6,42,21z' },
        child: [],
      },
    ],
  })(props);
...
function FcDownRight(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '44,29 30,17.3 30,40.7' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M6,21V8h8v13c0,2.2,1.8,4,4,4h17v8H18C11.4,33,6,27.6,6,21z' },
        child: [],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '24,44 12.3,30 35.7,30' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '6', width: '8', height: '27' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'polygon', attr: { points: '24,37.1 13,24 35,24' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '4', width: '8', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '10', width: '8', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '16', width: '8', height: '11' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '40', width: '36', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcEditImage(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#FFC107', points: '27.5,42.2 26,48 31.8,46.5' }, child: [] },
      { tag: 'polygon', attr: { fill: '#37474F', points: '26.7,45 26,48 29,47.3' }, child: [] },
    ],
  })(props);
}
function FcElectricalSensor(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#B2EBF2', cx: '32', cy: '24', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#4DD0E1',
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '32', cy: '24', r: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcElectricalThreshold(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '3', y: '12', fill: '#80DEEA', width: '42', height: '24' }, child: [] },
      { tag: 'rect', attr: { x: '3', y: '23', fill: '#03A9F4', width: '42', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: 'none',
...
function FcElectroDevices(props) {
  return GenIcon({
    tag: 'svg',
    attr: { version: '1', viewBox: '0 0 48 48' },
    child: [
      {
        tag: 'path',
        attr: {
    ...
    child: [
      {
        ...
        attr: { fill: '#FFCC80' },
        child: [
          { tag: 'polygon', attr: { points: '29,23 19,23 7,9 41,9' }, child: [] },
          { tag: 'polygon', attr: { points: '29,38 19,44 19,23 29,23' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcEmptyTrash(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#B39DDB', d: 'M30.6,44H17.4c-2,0-3.7-1.4-4-3.4L9,11h30l-4.5,29.6C34.2,42.6,32.5,44,30.6,44z' },
        child: [],
      },
      {
        tag: 'path',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#B71C1C' },
        child: [
          { tag: 'polygon', attr: { points: '24,40.5 16,31 32,31' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '24', width: '6', height: '7.5' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcEnteringHeavenAlive(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '17', y: '29', fill: '#039BE5', width: '14', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '13', y: '33', fill: '#039BE5', width: '22', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '37', fill: '#039BE5', width: '30', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '5', y: '41', fill: '#039BE5', width: '38', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#81D4FA',
      ...
      {
        tag: 'path',
        attr: { fill: '#039BE5', d: 'M28,21c0-2.2-1.8-4-4-4s-4,1.8-4,4c0,0.5,0,6,0,6h8C28,27,28,21.5,28,21z' },
        child: [],
      },
    ],
  })(props);
...
function FcExpand(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#2196F3', points: '43,17.1 39.9,14 24,29.9 8.1,14 5,17.1 24,36' }, child: [] },
    ],
  })(props);
}
function FcExpired(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#00ACC1', cx: '17', cy: '17', r: '14' }, child: [] },
      { tag: 'circle', attr: { fill: '#eee', cx: '17', cy: '17', r: '11' }, child: [] },
      { tag: 'rect', attr: { x: '16', y: '8', width: '2', height: '9' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '18.2',
      ...
      { tag: 'circle', attr: { fill: '#00ACC1', cx: '17', cy: '17', r: '1' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FFC107',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#FF5722' },
        child: [
          { tag: 'polygon', attr: { points: '42.7,24 32,33 32,15' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '21', width: '23', height: '6' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcExternal(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#B2DFDB', cx: '24', cy: '31', r: '14' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#009688' },
        child: [
          { tag: 'polygon', attr: { points: '24,3.3 33,14 15,14' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '11', width: '6', height: '23' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcFactoryBreakdown(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'polygon',
        attr: { fill: '#E64A19', points: '29,23 29,17 21,21 21,23 17,23 17,27 13,27 13,23 5,23 5,43 33,43 33,23' },
        child: [],
      },
      { tag: 'rect', attr: { x: '25', y: '27', fill: '#992B0A', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '35', fill: '#992B0A', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '25', y: '35', fill: '#992B0A', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '17', y: '35', fill: '#992B0A', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '17', y: '27', fill: '#992B0A', width: '4', height: '4' }, child: [] },
      { tag: 'polygon', attr: { fill: '#BF360C', points: '41.2,5 38,5 38,7 36,7 36,9 33.7,9 32,43 43,43' }, child: [] },
    ],
  })(props);
}
function FcFactory(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#BF360C', d: 'M41.2,5h-7.3L32,43h11L41.2,5z' }, child: [] },
      { tag: 'path', attr: { fill: '#E64A19', d: 'M33,23h-4v-6l-12,6v-6L5,23v20h28V23z' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '27', fill: '#FFC107', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '17', y: '27', fill: '#FFC107', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '25', y: '27', fill: '#FFC107', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '35', fill: '#FFC107', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '17', y: '35', fill: '#FFC107', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '25', y: '35', fill: '#FFC107', width: '4', height: '4' }, child: [] },
    ],
  })(props);
}
function FcFaq(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#558B2F', d: 'M15,40h23l6,6V25c0-2.2-1.8-4-4-4H15c-2.2,0-4,1.8-4,4v11C11,38.2,12.8,40,15,40z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M33,25H10l-6,6V8c0-2.2,1.8-4,4-4h25c2.2,0,4,1.8,4,4v13C37,23.2,35.2,25,33,25z' },
        child: [],
      },
      {
        tag: 'path',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '38.6,5.6 29,15.2 29,28 33,28 33,16.8 41.4,8.4' }, child: [] },
          { tag: 'polygon', attr: { points: '6.6,8.4 15,16.8 15,28 19,28 19,15.2 9.4,5.6' }, child: [] },
          { tag: 'polygon', attr: { points: '37,27 31,33 25,27' }, child: [] },
          { tag: 'polygon', attr: { points: '23,27 17,33 11,27' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcFeedback(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '12', y: '11', fill: '#fff', width: '24', height: '22' }, child: [] },
      { tag: 'polygon', attr: { fill: '#9C27B0', points: '24,13.6 18,21.4 30,21.4' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#CFD8DC', d: 'M40,41H8c-2.2,0-4-1.8-4-4l0-20l20,13l20-13v20C44,39.2,42.2,41,40,41z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#9C27B0', points: '24,28 26,26.7 26,20 22,20 22,26.7' }, child: [] },
    ],
  })(props);
}
...
function FcFilingCabinet(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '12', y: '44', fill: '#263238', width: '4', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '32', y: '44', fill: '#263238', width: '4', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#607D8B',
      ...
      { tag: 'path', attr: { fill: '#B0BEC5', d: 'M12,17V8c0-0.6,0.4-1,1-1h22c0.6,0,1,0.4,1,1v9H12z' }, child: [] },
      { tag: 'rect', attr: { x: '12', y: '19', fill: '#B0BEC5', width: '24', height: '10' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#B0BEC5', d: 'M12,40v-9h24v9c0,0.6-0.4,1-1,1H13C12.4,41,12,40.6,12,40z' },
        child: [],
      },
      { tag: 'rect', attr: { x: '20', y: '11', fill: '#546E7A', width: '8', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '20', y: '23', fill: '#546E7A', width: '8', height: '2' }, child: [] },
      { tag: 'rect', attr: { x: '20', y: '35', fill: '#546E7A', width: '8', height: '2' }, child: [] },
    ],
  })(props);
}
...
function FcFilmReel(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#3F51B5', d: 'M43,39V24h-4v15c0,5,4,9,9,9v-4C45.2,44,43,41.8,43,39z' }, child: [] },
      { tag: 'circle', attr: { fill: '#90A4AE', cx: '24', cy: '24', r: '19' }, child: [] },
      { tag: 'circle', attr: { fill: '#37474F', cx: '24', cy: '24', r: '2' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#253278' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '14', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '34', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '34', cy: '24', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '14', cy: '24', r: '5' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcFinePrint(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '33,42 5,42 5,4 24,4 33,13' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '31.5,14 23,14 23,5.5' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '38.3',
      ...
      { tag: 'circle', attr: { fill: '#616161', cx: '28', cy: '29', r: '11' }, child: [] },
      { tag: 'circle', attr: { fill: '#90CAF9', cx: '28', cy: '29', r: '9' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '39.5',
      ...
      },
      {
        ...
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'path', attr: { d: 'M30,31h-9.7c0.4,1.6,1.3,3,2.5,4H30V31z' }, child: [] },
          { tag: 'path', attr: { d: 'M20.3,27H30v-4h-7.3C21.5,24,20.7,25.4,20.3,27z' }, child: [] },
          { tag: 'path', attr: { d: 'M20.1,20H11v2h7.3C18.8,21.3,19.4,20.6,20.1,20z' }, child: [] },
          { tag: 'path', attr: { d: 'M17.1,24H11v2h5.4C16.6,25.3,16.8,24.6,17.1,24z' }, child: [] },
          { tag: 'path', attr: { d: 'M16,29c0-0.3,0-0.7,0.1-1H11v2h5.1C16,29.7,16,29.3,16,29z' }, child: [] },
          { tag: 'path', attr: { d: 'M16.4,32H11v2h6.1C16.8,33.4,16.6,32.7,16.4,32z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcFlashAuto(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#FFC107', points: '33,22 23.6,22 30,5 19,5 13,26 21.6,26 17,45' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#F44336',
...
function FcFlowChart(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '17', y: '6', fill: '#3F51B5', width: '14', height: '10' }, child: [] },
...
function FcFolder(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#FFA000', d: 'M40,12H22l-4-4H8c-2.2,0-4,1.8-4,4v8h40v-4C44,13.8,42.2,12,40,12z' },
        child: [],
      },
      {
        tag: 'path',
...
function FcFullTrash(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#FF8A65', points: '24,21.3 12.7,10 26,1.7 38.3,10' }, child: [] },
      { tag: 'polygon', attr: { fill: '#FFAB91', points: '24,21.3 12.7,10 17,4.7 38.3,10' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#B39DDB', d: 'M30.6,44H17.4c-2,0-3.7-1.4-4-3.4L9,11h30l-4.5,29.6C34.2,42.6,32.5,44,30.6,44z' },
        child: [],
...
function FcGallery(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#FFF9C4', cx: '30', cy: '16', r: '3' }, child: [] },
      { tag: 'polygon', attr: { fill: '#942A09', points: '17,17.9 8,31 26,31' }, child: [] },
      { tag: 'polygon', attr: { fill: '#BF360C', points: '28,23.5 22,31 34,31' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: {
          fill: '#CFD8DC',
          points:
            '40,9 40,7 31,7 31,12 24,12 15,12 15,23 8,23 8,25 15,25 15,36 24,36 31,36 31,41 40,41 40,39 33,39 33,31 40,31 40,29 31,29 31,34 24,34 17,34 17,14 24,14 31,14 31,19 40,19 40,17 33,17 33,9',
        },
        child: [],
      },
      { tag: 'rect', attr: { x: '4', y: '20', fill: '#00BCD4', width: '8', height: '8' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'rect', attr: { x: '36', y: '14', width: '8', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '36', y: '4', width: '8', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '9', width: '8', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '31', width: '8', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '36', y: '36', width: '8', height: '8' }, child: [] },
          { tag: 'rect', attr: { x: '36', y: '26', width: '8', height: '8' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcGenericSortingAsc(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '6', y: '6', fill: '#2196F3', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '14', fill: '#2196F3', width: '12', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '22', fill: '#2196F3', width: '20', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '30', fill: '#2196F3', width: '28', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '38', fill: '#2196F3', width: '36', height: '4' }, child: [] },
    ],
  })(props);
}
function FcGenericSortingDesc(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '6', y: '38', fill: '#2196F3', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '30', fill: '#2196F3', width: '12', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '22', fill: '#2196F3', width: '20', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '14', fill: '#2196F3', width: '28', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '6', fill: '#2196F3', width: '36', height: '4' }, child: [] },
    ],
  })(props);
}
function FcGlobe(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#7CB342', d: 'M24,4C13,4,4,13,4,24s9,20,20,20s20-9,20-20S35,4,24,4z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#0277BD',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#4CAF50' },
        child: [
          { tag: 'rect', attr: { x: '22', y: '16', width: '4', height: '18' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '23', width: '18', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'rect', attr: { x: '9', y: '20', width: '30', height: '13' }, child: [] },
          { tag: 'ellipse', attr: { cx: '24', cy: '33', rx: '15', ry: '6' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '43', cy: '37', r: '2' }, child: [] },
          { tag: 'path', attr: { d: 'M46,40c0,1.7-3,6-3,6s-3-4.3-3-6s1.3-3,3-3S46,38.3,46,40z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcHeadset(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#37474F', d: 'M38,43h-4V31h4c2.2,0,4,1.8,4,4v4C42,41.2,40.2,43,38,43z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#37474F', d: 'M10,43h4V31h-4c-2.2,0-4,1.8-4,4v4C6,41.2,7.8,43,10,43z' },
        child: [],
      },
    ],
  })(props);
...
function FcHeatMap(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#CFD8DC', points: '9,39 9,6 7,6 7,41 42,41 42,39' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'circle', attr: { cx: '14', cy: '11', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '11', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '39', cy: '11', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '23', cy: '11', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '14', cy: '33', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '30', cy: '33', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '22', cy: '33', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '38', cy: '33', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '14', cy: '22', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '39', cy: '22', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '22', r: '3' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcHighBattery(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M34,44H14c-1.1,0-2-0.9-2-2V13h24v29C36,43.1,35.1,44,34,44z' },
        child: [],
      },
    ],
  })(props);
...
function FcHome(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#E8EAF6', points: '42,39 6,39 6,23 24,6 42,23' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#C5CAE9' },
        child: [
          { tag: 'polygon', attr: { points: '39,21 34,16 34,9 39,9' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '39', width: '36', height: '5' }, child: [] },
        ],
      },
      { tag: 'polygon', attr: { fill: '#B71C1C', points: '24,4.3 4,22.9 6,25.1 24,8.4 42,25.1 44,22.9' }, child: [] },
      { tag: 'rect', attr: { x: '18', y: '28', fill: '#D84315', width: '12', height: '16' }, child: [] },
      { tag: 'rect', attr: { x: '21', y: '17', fill: '#01579B', width: '6', height: '6' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF8A65',
...
function FcIcons8Cup(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#4CAF50', d: 'M40,14H8l3.8,28.3c0.1,1,1,1.7,2,1.7h20.5c1,0,1.8-0.7,2-1.7L40,14z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#81C784' },
        child: [
          { tag: 'path', attr: { d: 'M42,14H6v-3c0-2.2,1.8-4,4-4h28c2.2,0,4,1.8,4,4V14z' }, child: [] },
          {
            tag: 'path',
...
function FcIdea(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#FFF59D', cx: '24', cy: '22', r: '20' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FBC02D',
      ...
      { tag: 'circle', attr: { fill: '#5C6BC0', cx: '24', cy: '44', r: '3' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#9FA8DA', d: 'M26,45h-4c-2.2,0-4-1.8-4-4v-5h12v5C30,43.2,28.2,45,26,45z' },
        child: [],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '18,38.7 18,40.7 30,39 30,37' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcImageFile(props) {
  return GenIcon({
    ...
    child: [
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '40,45 8,45 8,3 30,3 40,13' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '38.5,14 29,14 29,4.5' }, child: [] },
      { tag: 'polygon', attr: { fill: '#1565C0', points: '21,23 14,33 28,33' }, child: [] },
      { tag: 'polygon', attr: { fill: '#1976D2', points: '28,26.4 23,33 33,33' }, child: [] },
      { tag: 'circle', attr: { fill: '#1976D2', cx: '31.5', cy: '24.5', r: '1.5' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#E91E63' },
        child: [
          { tag: 'polygon', attr: { points: '13.3,24 24,15 24,33' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '21', width: '23', height: '6' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#9575CD' },
        child: [
          { tag: 'path', attr: { d: 'M8,36h22V13c0-2.2-1.8-4-4-4H4v23C4,34.2,5.8,36,8,36z' }, child: [] },
          { tag: 'rect', attr: { y: '9', width: '10', height: '2' }, child: [] },
          { tag: 'rect', attr: { y: '14', width: '10', height: '2' }, child: [] },
          { tag: 'rect', attr: { y: '19', width: '10', height: '2' }, child: [] },
          { tag: 'rect', attr: { y: '24', width: '10', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#7E57C2' },
        child: [
          { tag: 'rect', attr: { x: '4', y: '11', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '16', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '21', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '26', width: '4', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'g',
...
function FcInfo(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#2196F3', cx: '24', cy: '24', r: '21' }, child: [] },
      { tag: 'rect', attr: { x: '22', y: '22', fill: '#fff', width: '4', height: '11' }, child: [] },
      { tag: 'circle', attr: { fill: '#fff', cx: '24', cy: '16.5', r: '2.5' }, child: [] },
    ],
  })(props);
}
function FcInspection(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'polygon',
        attr: { fill: '#4CAF50', points: '30.6,18.6 21.6,27.6 17.4,23.3 14.9,25.8 21.7,32.5 33.1,21.1' },
        child: [],
      },
    ],
  })(props);
...
function FcIntegratedWebcam(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#455A64', cx: '24', cy: '24', r: '12' }, child: [] },
      { tag: 'circle', attr: { fill: '#42A5F5', cx: '24', cy: '24', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90CAF9',
...
function FcInternal(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#B3E5FC', cx: '24', cy: '30', r: '15' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'polygon', attr: { points: '24,38.7 15,28 33,28' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '5', width: '6', height: '26' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#4CAF50' },
        child: [
          { tag: 'rect', attr: { x: '22', y: '14', width: '4', height: '12' }, child: [] },
          { tag: 'rect', attr: { x: '18', y: '18', width: '12', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcIpad(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '24', cy: '42', r: '1.5' }, child: [] },
    ],
  })(props);
}
function FcIphone(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '24', cy: '41', r: '1.5' }, child: [] },
    ],
  })(props);
}
function FcKey(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '23', y: '26', fill: '#D68600', width: '2', height: '19' }, child: [] },
    ],
  })(props);
}
function FcKindle(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '20', y: '40', fill: '#546E7A', width: '8', height: '2' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#A1A1A1' },
        child: [
          { tag: 'rect', attr: { x: '16', y: '11', width: '16', height: '3' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '18', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '22', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '26', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '30', width: '12', height: '2' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'rect', attr: { x: '36', y: '8', width: '10', height: '10' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#FFEB3B', cx: '41', cy: '13', r: '3' }, child: [] },
      { tag: 'polygon', attr: { fill: '#2E7D32', points: '16.5,18 0,42 33,42' }, child: [] },
      { tag: 'polygon', attr: { fill: '#4CAF50', points: '33.6,24 19.2,42 48,42' }, child: [] },
    ],
  })(props);
}
function FcLeave(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#FFCDD2', d: 'M5,38V14h38v24c0,2.2-1.8,4-4,4H9C6.8,42,5,40.2,5,38z' }, child: [] },
      { tag: 'path', attr: { fill: '#F44336', d: 'M43,10v6H5v-6c0-2.2,1.8-4,4-4h30C41.2,6,43,7.8,43,10z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#B71C1C' },
...
function FcLeftDown(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '7,41 7,23 25,41' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '22.6',
...
function FcLeftDown2(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '19,44 30.7,30 7.3,30' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M27,6h13v8H27c-2.2,0-4,1.8-4,4v17h-8V18C15,11.4,20.4,6,27,6z' },
        child: [],
      },
    ],
  })(props);
...
function FcLeftUp(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '7,7 25,7 7,25' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '22.6',
...
function FcLeftUp2(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '19,4 30.7,18 7.3,18' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M27,42h13v-8H27c-2.2,0-4-1.8-4-4V13h-8v17C15,36.6,20.4,42,27,42z' },
        child: [],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '4,24 18,12.3 18,35.7' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '20', width: '27', height: '8' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#FF9800' },
        child: [
          { tag: 'rect', attr: { x: '1', y: '38', width: '46', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '25', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '37', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '18', width: '4', height: '16' }, child: [] },
          { tag: 'polygon', attr: { points: '43,16 5,16 5,13 24,4 43,13' }, child: [] },
          { tag: 'rect', attr: { x: '5', y: '34', width: '38', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#EF6C00' },
        child: [
          { tag: 'rect', attr: { x: '25', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '31', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '37', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '19', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '7', y: '16', width: '4', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '3', y: '36', width: '42', height: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '11', r: '2' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'circle', attr: { cx: '8', cy: '38', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '16', cy: '40', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '33', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '35', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '40', cy: '31', r: '3' }, child: [] },
          {
            tag: 'polygon',
            attr: {
              points:
                '39.1,29.2 31.8,32.9 23.5,30.8 15.5,37.8 8.5,36.1 7.5,39.9 16.5,42.2 24.5,35.2 32.2,37.1 40.9,32.8',
            },
            child: [],
          },
        ],
      },
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'circle', attr: { cx: '8', cy: '20', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '16', cy: '22', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '15', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '20', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '40', cy: '8', r: '3' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcLink(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#42A5F5', d: 'M33,21H15c-1.1,0-2,0.9-2,2s0.9,2,2,2h18c1.1,0,2-0.9,2-2S34.1,21,33,21z' },
        child: [],
      },
    ],
  })(props);
...
function FcLinux(props) {
  return GenIcon({
    tag: 'svg',
    attr: { version: '1.1', x: '0px', y: '0px', viewBox: '0 2 48 48', enableBackground: 'new 0 2 48 48' },
    child: [
      {
        tag: 'polygon',
        attr: {
          fill: '#ECEFF1',
          points:
            '20.1,18.2 20.2,20.5 18.6,23.5 16.1,28.4 15.6,32.5 17.4,38.3 21.5,40.6 27.7,40.6 33.5,36.2 \r\n	36.1,29.3 30.1,22 28.4,17.9 ',
        },
        child: [],
      },
      {
      ...
      },
      {
        ...
        attr: {},
        child: [
          { tag: 'ellipse', attr: { fill: '#ECEFF1', cx: '21.6', cy: '15.3', rx: '1.3', ry: '2' }, child: [] },
          { tag: 'ellipse', attr: { fill: '#ECEFF1', cx: '26.1', cy: '15.2', rx: '1.7', ry: '2.3' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'ellipse', attr: { fill: '#212121', cx: '26', cy: '15.6', rx: '1', ry: '1.3' }, child: [] },
        ],
      },
      {
        tag: 'g',
    ...
    child: [
      {
        ...
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '6', y: '22', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '14', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '30', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '6', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '38', width: '4', height: '4' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '14', y: '22', width: '28', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '14', width: '28', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '30', width: '28', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '6', width: '28', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '38', width: '28', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcLock(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#C76E00', cx: '24', cy: '31', r: '3' }, child: [] },
    ],
  })(props);
}
function FcLowBattery(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M34,44H14c-1.1,0-2-0.9-2-2v-9h24v9C36,43.1,35.1,44,34,44z' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#FFEB3B' },
        child: [
          { tag: 'polygon', attr: { points: '24,33.4 17,25 31,25' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '14.8', width: '4', height: '12.3' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcMakeDecision(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#FF5722', points: '24,23.5 24,12.5 30.6,18' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF5722',
...
function FcManager(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#CFD8DC', d: 'M29,31L29,31l-5,1l-5-1c0,0-11,2-11,13h32C40,33,29,31,29,31z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '23,35 22,44 26,44 25,35 26,34 24,32 22,34' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '24', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '24', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '16', cy: '24', r: '2' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#607D8B' },
        child: [
          { tag: 'rect', attr: { x: '6', y: '22', width: '36', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '10', width: '36', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '34', width: '36', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcMiddleBattery(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M34,44H14c-1.1,0-2-0.9-2-2V23h24v19C36,43.1,35.1,44,34,44z' },
        child: [],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: {
          fill: '#CFD8DC',
          points:
            '39.4,23 38.6,19 26,21.6 26,8 22,8 22,20.3 8.1,11.3 5.9,14.7 21.1,24.5 9.4,39.8 12.6,42.2 23.9,27.4 32.3,40.1 35.7,37.9 27.3,25.4',
        },
        child: [],
      },
      { tag: 'circle', attr: { fill: '#3F51B5', cx: '24', cy: '24', r: '7' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '8', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '39', cy: '21', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '7', cy: '13', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '11', cy: '41', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '34', cy: '39', r: '5' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcMinus(props) {
  return GenIcon({
    tag: 'svg',
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [{ tag: 'rect', attr: { x: '8', y: '21', fill: '#5C6BC0', width: '32', height: '6' }, child: [] }],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#F44336' },
        child: [
          { tag: 'polygon', attr: { points: '30.3,12.9 24,19.2 15.7,10.9 12.9,13.7 24,24.8 33.1,15.7' }, child: [] },
          { tag: 'polygon', attr: { points: '36,19 27,10 36,10' }, child: [] },
        ],
      },
      {
        tag: 'path',
...
function FcMms(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#E91E63', d: 'M37,39H11l-6,6V11c0-3.3,2.7-6,6-6h26c3.3,0,6,2.7,6,6v22C43,36.3,40.3,39,37,39z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#F48FB1', points: '20,16.5 10,31 30,31' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#F8BBD0' },
        child: [
          { tag: 'circle', attr: { cx: '34', cy: '15', r: '3' }, child: [] },
          { tag: 'polygon', attr: { points: '30,21 22,31 38,31' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcMoneyTransfer(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '14', y: '1', fill: '#AED581', width: '20', height: '31' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#558B2F' },
        child: [
          { tag: 'path', attr: { d: 'M13,0v33h22V0H13z M33,31H15V2h18V31z' }, child: [] },
          {
            tag: 'path',
            attr: { d: 'M34,3c0,1.7-0.3,3-2,3c-1.7,0-3-1.3-3-3s1.3-2,3-2C33.7,1,34,1.3,34,3z' },
            child: [],
          },
          { tag: 'path', attr: { d: 'M16,1c1.7,0,3,0.3,3,2s-1.3,3-3,3s-2-1.3-2-3S14.3,1,16,1z' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '8', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '24', cy: '20', r: '6' }, child: [] },
        ],
      },
      {
        tag: 'path',
...
function FcMultipleCameras(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#455A64', cx: '26', cy: '22', r: '10' }, child: [] },
      { tag: 'circle', attr: { fill: '#42A5F5', cx: '26', cy: '22', r: '7' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90CAF9',
      ...
      { tag: 'rect', attr: { x: '6', y: '12', fill: '#ADD8FB', width: '6', height: '3' }, child: [] },
    ],
  })(props);
}
function FcMultipleDevices(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#37474F', d: 'M38,33H6c-2.2,0-4-1.8-4-4v0h40v0C42,31.2,40.2,33,38,33z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '34', cy: '41.5', r: '1.5' }, child: [] },
    ],
  })(props);
}
function FcMultipleInputs(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#90A4AE', d: 'M40,35v5H8v-5H4v5c0,2.2,1.8,4,4,4h32c2.2,0,4-1.8,4-4v-5H40z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'polygon', attr: { points: '24,23.4 17,15 31,15' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '4', width: '4', height: '14' }, child: [] },
          {
            tag: 'path',
            attr: {
          ...
          { tag: 'polygon', attr: { points: '38.4,31 29.4,35 28,25' }, child: [] },
          {
            tag: 'path',
            attr: {
          ...
          { tag: 'polygon', attr: { points: '20,25 18.6,35 9.6,31' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcMultipleSmartphones(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#37474F', cx: '14', cy: '32.5', r: '1.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#546E7A',
      ...
      { tag: 'circle', attr: { fill: '#37474F', cx: '24', cy: '37.5', r: '1.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#E38939',
    ...
    child: [
      {
        ...
        attr: { fill: '#E91E63' },
        child: [
          { tag: 'circle', attr: { cx: '19', cy: '33', r: '9' }, child: [] },
          { tag: 'polygon', attr: { points: '24,6 24,33 28,33 28,14 39,17 39,10' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        child: [
          { tag: 'rect', attr: { x: '19', y: '22', width: '10', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '8', width: '10', height: '34' }, child: [] },
          { tag: 'rect', attr: { x: '32', y: '30', width: '10', height: '12' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '42,12 32,22 42,22' }, child: [] },
          {
            tag: 'rect',
            attr: {
              x: '32',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '25', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '32', cy: '25', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '16', cy: '25', r: '2' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#1565C0' },
        child: [
          { tag: 'polygon', attr: { points: '43.4,13 35,20 35,6' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '11', width: '34', height: '4' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '40', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '34', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '28', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '22', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '10', y: '23', width: '4', height: '19' }, child: [] },
          { tag: 'rect', attr: { x: '4', y: '23', width: '4', height: '19' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcNews(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#FF5722', d: 'M32,15v28H10c-2.2,0-4-1.8-4-4V15H32z' }, child: [] },
      { tag: 'path', attr: { fill: '#FFCCBC', d: 'M14,5v34c0,2.2-1.8,4-4,4h29c2.2,0,4-1.8,4-4V5H14z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FF5722' },
        child: [
          { tag: 'rect', attr: { x: '20', y: '10', width: '18', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '17', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '17', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '21', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '21', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '25', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '25', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '29', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '29', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '33', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '33', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '37', width: '8', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '37', width: '8', height: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcNext(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#2196F3', points: '17.1,5 14,8.1 29.9,24 14,39.9 17.1,43 36,24' }, child: [] },
    ],
  })(props);
}
...
function FcNightLandscape(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#673AB7', points: '16.5,18 0,42 33,42' }, child: [] },
      { tag: 'polygon', attr: { fill: '#9575CD', points: '33.6,24 19.2,42 48,42' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#40C4FF',
    ...
    child: [
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '22,37 17,31 17,25 27,25 27,31' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'path', attr: { d: 'M27,31L27,31c0,0-2,1-5,1s-5-1-5-1S6,33,6,44h32C38,33,27,31,27,31z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcNoVideo(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#388E3C', points: '44,35 34,29 34,19 44,13' }, child: [] },
      {
        tag: 'line',
        attr: {
          fill: 'none',
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#B0BEC5' },
        child: [
          { tag: 'rect', attr: { x: '16', y: '12', width: '16', height: '3' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '19', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '23', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '27', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '31', width: '12', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'path',
  ...
  return GenIcon({
    ...
    child: [
      { tag: 'polygon', attr: { fill: '#546E7A', points: '38,33 38,5 34,5 34,33 28,33 36,43 44,33' }, child: [] },
      {
        ...
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'path', attr: { d: 'M16.4,20h-3V8.6L9.9,9.7V7.3L16,5.1h0.3V20z' }, child: [] },
          {
            tag: 'path',
            attr: {
    ...
    child: [
      { tag: 'polygon', attr: { fill: '#546E7A', points: '38,33 38,5 34,5 34,33 28,33 36,43 44,33' }, child: [] },
      {
        ...
        child: [
          ...
          { tag: 'path', attr: { d: 'M16.2,43h-3V31.6l-3.5,1.1v-2.4l6.2-2.2h0.3V43z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcOk(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#4CAF50', cx: '24', cy: '24', r: '21' }, child: [] },
      {
        tag: 'polygon',
        attr: { fill: '#CCFF90', points: '34.6,14.6 21,28.2 15.4,22.6 12.6,25.4 21,33.8 37.4,17.4' },
        child: [],
...
function FcOldTimeCamera(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#546E7A', d: 'M14,13H8v-1.8C8,10.5,8.5,10,9.2,10h3.6c0.7,0,1.2,0.5,1.2,1.2V13z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#5E35B1', d: 'M40,40H8c-2.2,0-4-1.8-4-4V22h40v14C44,38.2,42.2,40,40,40z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'path', attr: { fill: '#78909C', d: 'M8,12h32c2.2,0,4,1.8,4,4v6H4v-6C4,13.8,5.8,12,8,12z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#78909C',
      ...
      { tag: 'path', attr: { fill: '#455A64', d: 'M35.3,22c-1.6-4.7-6.1-8-11.3-8s-9.7,3.3-11.3,8H35.3z' }, child: [] },
      { tag: 'circle', attr: { fill: '#B388FF', cx: '24', cy: '26', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
      ...
      { tag: 'rect', attr: { x: '36', y: '15', fill: '#DBE2E5', width: '5', height: '4' }, child: [] },
    ],
  })(props);
}
function FcOnlineSupport(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '13', y: '30', fill: '#BF360C', width: '22', height: '12' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFA726' },
        child: [
      ...
      },
      {
        ...
        attr: { fill: '#784719' },
        child: [
          { tag: 'circle', attr: { cx: '30', cy: '26', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '18', cy: '26', r: '2' }, child: [] },
        ],
      },
      {
        tag: 'path',
...
function FcOrgUnit(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#90CAF9', d: 'M10,10v28h28V10H10z M34,34H14V14h20V34z' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '6', fill: '#D81B60', width: '12', height: '12' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '30', y: '6', width: '12', height: '12' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '30', width: '12', height: '12' }, child: [] },
          { tag: 'rect', attr: { x: '30', y: '30', width: '12', height: '12' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcOrganization(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#90CAF9', d: 'M42,42H6V10c0-2.2,1.8-4,4-4h28c2.2,0,4,1.8,4,4V42z' }, child: [] },
      { tag: 'rect', attr: { x: '6', y: '42', fill: '#64B5F6', width: '36', height: '2' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1565C0' },
        child: [
          ...
          { tag: 'rect', attr: { x: '21', y: '11', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '11', y: '11', width: '6', height: '5' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '35', width: '6', height: '9' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcOvertime(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#CFD8DC', d: 'M12,40V20h32v20c0,2.2-1.8,4-4,4H16C13.8,44,12,42.2,12,40z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#78909C', d: 'M44,16v6H12v-6c0-2.2,1.8-4,4-4h24C42.2,12,44,13.8,44,16z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#37474F' },
        child: [
          { tag: 'circle', attr: { cx: '37', cy: '16', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '20', cy: '16', r: '3' }, child: [] },
        ],
      },
      {
        tag: 'g',
      ...
      { tag: 'rect', attr: { x: '32', y: '34', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '26', y: '34', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '20', y: '34', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '32', y: '28', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '26', y: '28', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '20', y: '28', fill: '#90A4AE', width: '4', height: '4' }, child: [] },
      { tag: 'circle', attr: { fill: '#F44336', cx: '16', cy: '15', r: '12' }, child: [] },
      { tag: 'circle', attr: { fill: '#eee', cx: '16', cy: '15', r: '9' }, child: [] },
      { tag: 'rect', attr: { x: '15', y: '8', width: '2', height: '7' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '16.9',
      ...
      { tag: 'circle', attr: { cx: '16', cy: '15', r: '1.5' }, child: [] },
    ],
  })(props);
}
...
function FcPaid(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#388E3C', d: 'M37.4,41H10.6c-1,0-1.8-0.7-2-1.6L5,21h38l-3.7,18.4C39.1,40.3,38.3,41,37.4,41z' },
        child: [],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'polygon',
        attr: { fill: '#DCEDC8', points: '30.8,24.8 22.9,32.7 19.2,28.9 17,31.1 22.9,37 33,26.9' },
        child: [],
      },
    ],
  })(props);
...
function FcPanorama(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#F57C00', d: 'M4,9v32c0,0,8.4-3,20-3s20,3,20,3V9c0,0-6.7,3-20,3S4,9,4,9z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#942A09', d: 'M24,34c0.1,0,0.3,0,0.4,0L15,19L6.9,36.2C10.3,35.3,16.5,34,24,34z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#BF360C', d: 'M24,34c3.3,0,6.3,0.2,9,0.6l-8-11.8l-7.8,11.5C19.3,34.1,21.6,34,24,34z' },
        child: [],
      },
      { tag: 'path', attr: { fill: '#E65100', d: 'M40.7,36L35,26.5l-5,7.8C34.5,34.7,38.2,35.4,40.7,36z' }, child: [] },
      { tag: 'ellipse', attr: { fill: '#FFF9C4', cx: '36', cy: '19.5', rx: '2', ry: '2.5' }, child: [] },
    ],
  })(props);
}
function FcParallelTasks(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '6', y: '17', fill: '#D81B60', width: '10', height: '14' }, child: [] },
      { tag: 'rect', attr: { x: '32', y: '6', fill: '#2196F3', width: '10', height: '10' }, child: [] },
...
function FcPhoneAndroid(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '21', y: '40', fill: '#78909C', width: '6', height: '2' }, child: [] },
    ],
  })(props);
}
...
function FcPhotoReel(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#673AB7', d: 'M10,9c-2.2,0-4,1.8-4,4v26c0,2.2,1.8,4,4,4h16c2.2,0,4-1.8,4-4V13c0-2.2-1.8-4-4-4' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#311B92' },
        child: [
          { tag: 'rect', attr: { x: '14', y: '13', width: '2', height: '26' }, child: [] },
          { tag: 'path', attr: { d: 'M24,9V7c0-1.2-0.8-2-2-2h-8c-1.2,0-2,0.8-2,2v2H24z' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'path',
        attr: { fill: '#FF5722', d: 'M30,13v2h3v4h-3v14h3v4h-3v2h12V13H30z M39,37h-3v-4h3V37z M39,19h-3v-4h3V19z' },
        child: [],
      },
    ],
  })(props);
...
function FcPicture(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#FFF9C4', cx: '35', cy: '16', r: '3' }, child: [] },
      { tag: 'polygon', attr: { fill: '#942A09', points: '20,16 9,32 31,32' }, child: [] },
      { tag: 'polygon', attr: { fill: '#BF360C', points: '31,22 23,32 39,32' }, child: [] },
    ],
  })(props);
}
function FcPieChart(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#00BCD4', d: 'M24,6C14.1,6,6,14.1,6,24s8.1,18,18,18c5.2,0,9.9-2.2,13.1-5.7L24,24V6z' },
        child: [],
      },
      { tag: 'path', attr: { fill: '#448AFF', d: 'M42,24c0-9.9-8.1-18-18-18v18H42z' }, child: [] },
      { tag: 'path', attr: { fill: '#3F51B5', d: 'M24,24l13.1,12.3c3-3.2,4.9-7.5,4.9-12.3H24z' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#B0BEC5' },
        child: [
          { tag: 'rect', attr: { x: '13', y: '21', width: '6', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '21', width: '6', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '29', y: '21', width: '6', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '29', width: '6', height: '6' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '29', width: '6', height: '6' }, child: [] },
        ],
      },
      { tag: 'rect', attr: { x: '29', y: '29', fill: '#F44336', width: '6', height: '6' }, child: [] },
    ],
  })(props);
}
  ...
  return GenIcon({
    ...
    child: [
      { tag: 'circle', attr: { fill: '#4CAF50', cx: '24', cy: '24', r: '21' }, child: [] },
      {
        ...
        attr: { fill: '#fff' },
        child: [
          { tag: 'rect', attr: { x: '21', y: '14', width: '6', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '21', width: '20', height: '6' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcPodiumWithAudience(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#B0BEC5', points: '41,12 7,12 6,16 11,19 9,16 39,16 37,19 42,16' }, child: [] },
      { tag: 'polygon', attr: { fill: '#78909C', points: '9,16 39,16 35,28 13,28' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '24', cy: '28', r: '4' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '36', cy: '28', r: '4' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '12', cy: '28', r: '4' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '18', cy: '37', r: '5' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '30', cy: '37', r: '5' }, child: [] },
    ],
  })(props);
}
function FcPodiumWithSpeaker(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '24', cy: '11', r: '6' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#607D8B', d: 'M36,26.1c0,0-3.3-7.1-12-7.1s-12,7.1-12,7.1V30h24V26.1z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#B0BEC5', points: '41,25 7,25 6,29 11,32 9,29 39,29 37,32 42,29' }, child: [] },
      { tag: 'polygon', attr: { fill: '#78909C', points: '9,29 39,29 35,41 13,41' }, child: [] },
    ],
  })(props);
}
function FcPodiumWithoutSpeaker(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#B0BEC5', points: '43,16 5,16 4,20 9,23 7,20 41,20 39,23 44,20' }, child: [] },
      { tag: 'polygon', attr: { fill: '#78909C', points: '7,20 41,20 37,36 11,36' }, child: [] },
    ],
  })(props);
}
function FcPortraitMode(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#FF9800', d: 'M22,38c-4.8,0-5-7-5-7v-6h10v6C27,31,26.8,38,22,38z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFA726' },
        child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#009688', d: 'M27,31L27,31c0,0-1.8,2-5,2s-5-2-5-2S6,33,6,44h32C38,33,27,31,27,31z' },
        child: [],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'rect', attr: { x: '36', y: '6', width: '10', height: '10' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#FFEB3B', cx: '41', cy: '11', r: '3' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        child: [
          { tag: 'rect', attr: { x: '19', y: '22', width: '10', height: '20' }, child: [] },
          { tag: 'rect', attr: { x: '32', y: '8', width: '10', height: '34' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '30', width: '10', height: '12' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '11,8 21,18 21,8' }, child: [] },
          {
            tag: 'rect',
            attr: {
              x: '11',
...
function FcPrevious(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#2196F3', points: '30.9,43 34,39.9 18.1,24 34,8.1 30.9,5 12,24' }, child: [] },
    ],
  })(props);
}
function FcPrint(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '9', y: '11', fill: '#424242', width: '30', height: '3' }, child: [] },
      { tag: 'path', attr: { fill: '#616161', d: 'M4,25h40v-7c0-2.2-1.8-4-4-4H8c-2.2,0-4,1.8-4,4V25z' }, child: [] },
      { tag: 'path', attr: { fill: '#424242', d: 'M8,36h32c2.2,0,4-1.8,4-4v-8H4v8C4,34.2,5.8,36,8,36z' }, child: [] },
      { tag: 'circle', attr: { fill: '#00E676', cx: '40', cy: '18', r: '1' }, child: [] },
      ...
      { tag: 'rect', attr: { x: '11', y: '31', fill: '#90CAF9', width: '26', height: '11' }, child: [] },
      { tag: 'rect', attr: { x: '11', y: '29', fill: '#42A5F5', width: '26', height: '2' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'rect', attr: { x: '16', y: '33', width: '17', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '37', width: '13', height: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcPrivacy(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#EFEBE9', cx: '24', cy: '31', r: '6' }, child: [] },
      { tag: 'circle', attr: { fill: '#1E88E5', cx: '24', cy: '31', r: '3' }, child: [] },
      { tag: 'circle', attr: { fill: '#fff', cx: '26', cy: '29', r: '1' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#9C27B0' },
        child: [
          { tag: 'polygon', attr: { points: '31,8 42.9,9.6 33.1,19.4' }, child: [] },
          { tag: 'polygon', attr: { points: '17,40 5.1,38.4 14.9,28.6' }, child: [] },
          { tag: 'polygon', attr: { points: '8,17 9.6,5.1 19.4,14.9' }, child: [] },
          {
            tag: 'path',
            attr: {
          ...
          { tag: 'polygon', attr: { points: '40,31 38.4,42.9 28.6,33.1' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '8', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '37', cy: '14', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '39', cy: '27', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '7', cy: '13', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '13', cy: '39', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '15', cy: '25', r: '4' }, child: [] },
          { tag: 'circle', attr: { cx: '33', cy: '39', r: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcRating(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#F44336', cx: '24', cy: '24', r: '21' }, child: [] },
      {
        tag: 'polygon',
        attr: {
          fill: '#FFCA28',
...
function FcReadingEbook(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#2196F3', d: 'M33.5,27c-2.2-3-5.2-5-9.5-5s-7.3,2-9.5,5H33.5z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#546E7A',
      ...
      { tag: 'circle', attr: { fill: '#B0BEC5', cx: '34', cy: '29', r: '1' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFB74D' },
        child: [
...
function FcReading(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#5C6BC0', d: 'M40,40c-6.9,0-16,4-16,4V22c0,0,9-4,18-4L40,40z' }, child: [] },
      { tag: 'path', attr: { fill: '#7986CB', d: 'M8,40c6.9,0,16,4,16,4V22c0,0-9-4-18-4L8,40z' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFB74D' },
        child: [
    ...
    child: [
      {
        ...
        child: [
          ...
          },
          {
            tag: 'g',
            attr: {},
            child: [{ tag: 'circle', attr: { fill: '#FFFFFF', cx: '38.32', cy: '10.475', r: '3.5' }, child: [] }],
          },
          {
            tag: 'g',
            attr: {},
            child: [
              {
                tag: 'ellipse',
                attr: { fill: '#FFFFFF', cx: '24.085', cy: '28.611', rx: '18.085', ry: '12.946' },
                child: [],
              },
            ],
          },
      ...
      },
      {
        ...
        attr: {},
        child: [
          { tag: 'circle', attr: { fill: '#D84315', cx: '30.365', cy: '26.39', r: '2.884' }, child: [] },
          { tag: 'circle', attr: { fill: '#D84315', cx: '17.635', cy: '26.39', r: '2.884' }, child: [] },
        ],
      },
      {
        tag: 'g',
    ...
    child: [
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'polygon', attr: { points: '43,18 29,6.3 29,29.7' }, child: [] },
          {
            tag: 'path',
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '4.6,22 11,30.4 17.4,22' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '30.6,26 37,17.6 43.4,26' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcReuse(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#455A64', points: '12.1,42 17.2,42 16.5,18.2 10.9,20.2' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFB74D', cx: '36.5', cy: '10', r: '5' }, child: [] },
      { tag: 'polygon', attr: { fill: '#607D8B', points: '11,42 6,42 7.8,18.6 14.2,20.9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#607D8B',
...
function FcRightDown(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '41,41 23,41 41,23' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '17.4',
...
function FcRightDown2(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '29,44 17.3,30 40.7,30' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M21,6H8v8h13c2.2,0,4,1.8,4,4v17h8V18C33,11.4,27.6,6,21,6z' },
        child: [],
      },
    ],
  })(props);
...
function FcRightUp(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '41,7 41,25 23,7' }, child: [] },
      {
        tag: 'rect',
        attr: {
          x: '17.4',
...
function FcRightUp2(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '29,4 17.3,18 40.7,18' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M21,42H8v-8h13c2.2,0,4-1.8,4-4V13h8v17C33,36.6,27.6,42,21,42z' },
        child: [],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '44,24 30,35.7 30,12.3' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '20', width: '27', height: '8' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'path', attr: { d: 'M14,11H8V9.2C8,8.5,8.5,8,9.2,8h3.6C13.5,8,14,8.5,14,9.2V11z' }, child: [] },
          {
            tag: 'path',
...
function FcRotateToLandscape(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#9C27B0', points: '22,34 27.9,27 16.1,27' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#9C27B0',
...
function FcRotateToPortrait(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#9C27B0', points: '26,15 20.1,22 31.9,22' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#9C27B0', d: 'M24,21v6c0,1.1-0.9,2-2,2s-2-0.9-2-2v-2h-4v2c0,3.3,2.7,6,6,6s6-2.7,6-6v-6H24z' },
        child: [],
      },
    ],
  })(props);
...
function FcRules(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#42A5F5', d: 'M39,45H9c0,0-3-0.1-3-8h36C42,44.9,39,45,39,45z' }, child: [] },
      { tag: 'rect', attr: { x: '8', y: '3', fill: '#90CAF9', width: '32', height: '34' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'rect', attr: { x: '18', y: '15', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '18', y: '19', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '18', y: '23', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '18', y: '27', width: '16', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '18', y: '31', width: '16', height: '2' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#1976D2' },
        child: [
          { tag: 'rect', attr: { x: '14', y: '15', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '27', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '14', y: '31', width: '2', height: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSafe(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '8', y: '39', fill: '#455A64', width: '6', height: '3' }, child: [] },
      { tag: 'rect', attr: { x: '34', y: '39', fill: '#455A64', width: '6', height: '3' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#78909C',
      ...
      {
        tag: 'path',
        attr: { fill: '#455A64', d: 'M12,20c-1.1,0-2,0.9-2,2v8c0,1.1,0.9,2,2,2s2-0.9,2-2v-8C14,20.9,13.1,20,12,20z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#CFD8DC', d: 'M12,18c-1.1,0-2,0.9-2,2v8c0,1.1,0.9,2,2,2s2-0.9,2-2v-8C14,18.9,13.1,18,12,18z' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#FFC107' },
        child: [
          { tag: 'ellipse', attr: { cx: '38', cy: '8', rx: '6', ry: '2' }, child: [] },
          {
            tag: 'path',
            attr: {
      ...
      },
      {
        ...
        attr: { fill: '#FFC107' },
        child: [
          { tag: 'ellipse', attr: { cx: '10', cy: '14', rx: '6', ry: '2' }, child: [] },
          {
            tag: 'path',
            attr: {
      ...
      },
      {
        ...
        attr: { fill: '#FFC107' },
        child: [
          { tag: 'ellipse', attr: { cx: '24', cy: '23', rx: '6', ry: '2' }, child: [] },
          {
            tag: 'path',
            attr: {
  ...
  return GenIcon({
    ...
    child: [
      { tag: 'polygon', attr: { fill: '#CFD8DC', points: '9,39 9,6 7,6 7,41 42,41 42,39' }, child: [] },
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'circle', attr: { cx: '39', cy: '11', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '31', cy: '13', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '37', cy: '19', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '34', cy: '26', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '28', cy: '20', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '26', cy: '28', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '20', cy: '23', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '21', cy: '33', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '14', cy: '30', r: '3' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '20', cy: '20', r: '16' }, child: [] },
        ],
      },
      {
        tag: 'rect',
      ...
      { tag: 'circle', attr: { fill: '#64B5F6', cx: '20', cy: '20', r: '13' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#BBDEFB',
...
function FcSelfServiceKiosk(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'path', attr: { fill: '#546E7A', d: 'M44,30H4V11c0-2.2,1.8-4,4-4h32c2.2,0,4,1.8,4,4V30z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#64B5F6',
      ...
      {
        tag: 'path',
        attr: { fill: '#78909C', d: 'M40,41H8c-2.2,0-4-1.8-4-4v-7h40v7C44,39.2,42.2,41,40,41z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#37474F' },
        child: [
          { tag: 'rect', attr: { x: '27', y: '34', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '9', y: '34', width: '12', height: '2' }, child: [] },
          { tag: 'path', attr: { d: 'M18,35c0,1.1-1.3,2-3,2s-3-0.9-3-2H18z' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSelfie(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '40', y: '30', fill: '#78909C', width: '2', height: '6' }, child: [] },
      { tag: 'rect', attr: { x: '19', y: '32', fill: '#BF360C', width: '8', height: '9' }, child: [] },
      { tag: 'rect', attr: { x: '20.5', y: '37.5', fill: '#FF9800', width: '5', height: '3.5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FFB74D',
      ...
      },
      {
        ...
        child: [
          ...
          { tag: 'circle', attr: { cx: '25', cy: '35.5', r: '.5' }, child: [] },
          { tag: 'circle', attr: { cx: '21', cy: '35.5', r: '.5' }, child: [] },
        ],
      },
      {
        tag: 'g',
...
function FcSerialTasks(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#90CAF9', d: 'M33,9H11v4h22c1.1,0,2,0.9,2,2v20H23v4h16V15C39,11.7,36.3,9,33,9z' },
        child: [],
      },
      { tag: 'rect', attr: { x: '6', y: '6', fill: '#D81B60', width: '10', height: '10' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '32', y: '17', width: '10', height: '10' }, child: [] },
          { tag: 'rect', attr: { x: '16', y: '32', width: '10', height: '10' }, child: [] },
          { tag: 'circle', attr: { cx: '26', cy: '11', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '37', cy: '37', r: '5' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#1E88E5' },
        child: [
          { tag: 'circle', attr: { cx: '11', cy: '24', r: '7' }, child: [] },
          { tag: 'circle', attr: { cx: '37', cy: '14', r: '7' }, child: [] },
          { tag: 'circle', attr: { cx: '37', cy: '34', r: '7' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcShipped(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#8BC34A', d: 'M43,36H29V14h10.6c0.9,0,1.6,0.6,1.9,1.4L45,26v8C45,35.1,44.1,36,43,36z' },
        child: [],
      },
      {
        tag: 'path',
        attr: { fill: '#388E3C', d: 'M29,36H5c-1.1,0-2-0.9-2-2V9c0-1.1,0.9-2,2-2h22c1.1,0,2,0.9,2,2V36z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#37474F' },
        child: [
          { tag: 'circle', attr: { cx: '37', cy: '36', r: '5' }, child: [] },
          { tag: 'circle', attr: { cx: '13', cy: '36', r: '5' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#78909C' },
        child: [
          { tag: 'circle', attr: { cx: '37', cy: '36', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '13', cy: '36', r: '2' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      {
        tag: 'polygon',
        attr: { fill: '#DCEDC8', points: '21.8,13.8 13.9,21.7 10.2,17.9 8,20.1 13.9,26 24,15.9' },
        child: [],
      },
    ],
  })(props);
...
function FcShop(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '5', y: '19', fill: '#CFD8DC', width: '38', height: '19' }, child: [] },
      { tag: 'rect', attr: { x: '5', y: '38', fill: '#B0BEC5', width: '38', height: '4' }, child: [] },
      { tag: 'rect', attr: { x: '27', y: '24', fill: '#455A64', width: '12', height: '18' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '24', fill: '#E3F2FD', width: '14', height: '11' }, child: [] },
      { tag: 'rect', attr: { x: '10', y: '25', fill: '#1E88E5', width: '12', height: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90A4AE',
      ...
      },
      {
        ...
        attr: { fill: '#558B2F' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '19', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '36', cy: '19', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '12', cy: '19', r: '3' }, child: [] },
        ],
      },
      { tag: 'path', attr: { fill: '#7CB342', d: 'M40,6H8C6.9,6,6,6.9,6,8v3h36V8C42,6.9,41.1,6,40,6z' }, child: [] },
      { tag: 'rect', attr: { x: '21', y: '11', fill: '#7CB342', width: '6', height: '8' }, child: [] },
      { tag: 'polygon', attr: { fill: '#7CB342', points: '37,11 32,11 33,19 39,19' }, child: [] },
      { tag: 'polygon', attr: { fill: '#7CB342', points: '11,11 16,11 15,19 9,19' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#FFA000' },
        child: [
          { tag: 'circle', attr: { cx: '30', cy: '19', r: '3' }, child: [] },
          { tag: 'path', attr: { d: 'M45,19c0,1.7-1.3,3-3,3s-3-1.3-3-3s1.3-3,3-3L45,19z' }, child: [] },
          { tag: 'circle', attr: { cx: '18', cy: '19', r: '3' }, child: [] },
          { tag: 'path', attr: { d: 'M3,19c0,1.7,1.3,3,3,3s3-1.3,3-3s-1.3-3-3-3L3,19z' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#FFC107' },
        child: [
          { tag: 'polygon', attr: { points: '32,11 27,11 27,19 33,19' }, child: [] },
          { tag: 'polygon', attr: { points: '42,11 37,11 39,19 45,19' }, child: [] },
          { tag: 'polygon', attr: { points: '16,11 21,11 21,19 15,19' }, child: [] },
          { tag: 'polygon', attr: { points: '6,11 11,11 9,19 3,19' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSignature(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '3', y: '40', fill: '#90A4AE', width: '42', height: '2' }, child: [] },
    ],
  })(props);
}
...
function FcSimCard(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { fill: '#FFD54F', d: 'M29,30v3h5v2h-5v3h-2V22h2v6h5v2H29z M14,29v2h5v2h-5v2h5v3h2v-9H14z' },
        child: [],
      },
    ],
  })(props);
...
function FcSlrBackSide(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#942A09', points: '18.9,22 12,32 25.8,32' }, child: [] },
      { tag: 'circle', attr: { fill: '#FFF9C4', cx: '27', cy: '21', r: '2' }, child: [] },
      { tag: 'polygon', attr: { fill: '#BF360C', points: '25.2,26 20.4,32 30,32' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#8667C4' },
        child: [
          { tag: 'path', attr: { d: 'M34,10h6V9.2C40,8.5,39.5,8,38.8,8h-3.6C34.5,8,34,8.5,34,9.2V10z' }, child: [] },
          { tag: 'circle', attr: { cx: '38', cy: '18', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '38', cy: '24', r: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '38', cy: '30', r: '2' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSmartphoneTablet(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '15', y: '39', fill: '#78909C', width: '6', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#E38939',
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '34', cy: '42.5', r: '1.5' }, child: [] },
    ],
  })(props);
}
function FcSms(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#009688', d: 'M37,39H11l-6,6V11c0-3.3,2.7-6,6-6h26c3.3,0,6,2.7,6,6v22C43,36.3,40.3,39,37,39z' },
        child: [],
      },
      {
        tag: 'g',
        attr: { fill: '#fff' },
        child: [
          { tag: 'circle', attr: { cx: '24', cy: '22', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '34', cy: '22', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '14', cy: '22', r: '3' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSpeaker(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { fill: '#546E7A', d: 'M14,32H7c-1.1,0-2-0.9-2-2V18c0-1.1,0.9-2,2-2h7V32z' }, child: [] },
      { tag: 'polygon', attr: { fill: '#78909C', points: '26,42 14,32 14,16 26,6' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#03A9F4',
...
function FcSportsMode(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'circle', attr: { fill: '#FF9800', cx: '28', cy: '9', r: '5' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#00796B',
...
function FcStackOfPhotos(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '4', y: '4', fill: '#BBDEFB', width: '28', height: '28' }, child: [] },
      { tag: 'rect', attr: { x: '7', y: '7', fill: '#4CAF50', width: '22', height: '20' }, child: [] },
      { tag: 'path', attr: { fill: '#fff', d: 'M16,13c0-1.1,0.9-2,2-2s2,0.9,2,2s-2,4-2,4S16,14.1,16,13z' }, child: [] },
      { tag: 'path', attr: { fill: '#fff', d: 'M20,21c0,1.1-0.9,2-2,2s-2-0.9-2-2s2-4,2-4S20,19.9,20,21z' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#fff',
      ...
      { tag: 'circle', attr: { fill: '#FFC107', cx: '18', cy: '17', r: '2' }, child: [] },
    ],
  })(props);
}
function FcStart(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#fff', points: '31,24 20,16 20,32' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'rect', attr: { x: '23', y: '5', width: '2', height: '36' }, child: [] },
          {
            tag: 'rect',
            attr: {
              x: '20.5',
      ...
      { tag: 'rect', attr: { x: '4', y: '8', fill: '#CFD8DC', width: '40', height: '28' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#607D8B' },
        child: [
          { tag: 'rect', attr: { x: '3', y: '7', width: '42', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '3', y: '35', width: '42', height: '2' }, child: [] },
          { tag: 'circle', attr: { cx: '31.5', cy: '43.5', r: '1.5' }, child: [] },
          { tag: 'circle', attr: { cx: '16.5', cy: '43.5', r: '1.5' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          ...
          { tag: 'polygon', attr: { points: '36,24 29,17 36,17' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#CFD8DC' },
        child: [
          { tag: 'rect', attr: { x: '21', y: '20', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '19', width: '4', height: '4' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#03A9F4' },
        child: [
          { tag: 'rect', attr: { x: '21', y: '29', width: '12', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '15', y: '28', width: '4', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcSynchronize(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'polygon', attr: { fill: '#FF6F02', points: '31,8 42.9,9.6 33.1,19.4' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#FF6F00',
      ...
      { tag: 'polygon', attr: { fill: '#FF6F02', points: '17,40 5.1,38.4 14.9,28.6' }, child: [] },
    ],
  })(props);
}
function FcTabletAndroid(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '21', y: '41', fill: '#78909C', width: '6', height: '2' }, child: [] },
    ],
  })(props);
}
function FcTemplate(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '4', y: '7', fill: '#BBDEFB', width: '40', height: '34' }, child: [] },
      { tag: 'rect', attr: { x: '9', y: '12', fill: '#3F51B5', width: '30', height: '5' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '9', y: '21', width: '13', height: '16' }, child: [] },
          { tag: 'rect', attr: { x: '26', y: '21', width: '13', height: '16' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcTimeline(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '9', y: '6', fill: '#CFD8DC', width: '2', height: '36' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#90A4AE' },
        child: [
          { tag: 'circle', attr: { cx: '10', cy: '10', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '10', cy: '24', r: '3' }, child: [] },
          { tag: 'circle', attr: { cx: '10', cy: '38', r: '3' }, child: [] },
        ],
      },
      {
        tag: 'path',
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '17.8,18.1 10.4,25.4 6.2,21.3 4,23.5 10.4,29.9 20,20.3' }, child: [] },
          { tag: 'polygon', attr: { points: '17.8,5.1 10.4,12.4 6.2,8.3 4,10.5 10.4,16.9 20,7.3' }, child: [] },
          { tag: 'polygon', attr: { points: '17.8,31.1 10.4,38.4 6.2,34.3 4,36.5 10.4,42.9 20,33.3' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#90CAF9' },
        child: [
          { tag: 'rect', attr: { x: '24', y: '22', width: '20', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '24', y: '9', width: '20', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '24', y: '35', width: '20', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcTouchscreenSmartphone(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '24', cy: '41', r: '1.5' }, child: [] },
      { tag: 'circle', attr: { fill: '#E91E63', cx: '24', cy: '23', r: '2' }, child: [] },
      {
        tag: 'circle',
        attr: { fill: 'none', stroke: '#F48FB1', strokeWidth: '2', strokeMiterlimit: '10', cx: '24', cy: '23', r: '4' },
        child: [],
      },
      {
        tag: 'circle',
        attr: { fill: 'none', stroke: '#F8BBD0', strokeMiterlimit: '10', cx: '24', cy: '23', r: '6.5' },
        child: [],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      { tag: 'circle', attr: { fill: '#9C27B0', cx: '24', cy: '24', r: '21' }, child: [] },
      {
        ...
        attr: { fill: '#E1BEE7' },
        child: [
          { tag: 'path', attr: { d: 'M20.6,18.5h-4.2v14.2h-3.5V18.5H8.7v-2.9h11.9V18.5z' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcTreeStructure(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'polygon',
        attr: { fill: '#90CAF9', points: '36.9,13.8 35.1,10.2 7.5,24 35.1,37.8 36.9,34.2 16.5,24' },
        child: [],
      },
      { tag: 'rect', attr: { x: '6', y: '18', fill: '#D81B60', width: '12', height: '12' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
...
function FcTwoSmartphones(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'rect', attr: { x: '14', y: '36', fill: '#78909C', width: '6', height: '2' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#E38939',
      ...
      { tag: 'circle', attr: { fill: '#A6642A', cx: '31', cy: '41', r: '1.5' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#00BCD4' },
        child: [
          { tag: 'polygon', attr: { points: '5,18 19,6.3 19,29.7' }, child: [] },
          {
            tag: 'path',
...
function FcUpLeft(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '4,19 18,30.7 18,7.3' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M42,27v13h-8V27c0-2.2-1.8-4-4-4H13v-8h17C36.6,15,42,20.4,42,27z' },
        child: [],
      },
    ],
  })(props);
...
function FcUpRight(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '44,19 30,30.7 30,7.3' }, child: [] },
      {
        tag: 'path',
        attr: { fill: '#3F51B5', d: 'M6,27v13h8V27c0-2.2,1.8-4,4-4h17v-8H18C11.4,15,6,20.4,6,27z' },
        child: [],
      },
      { tag: 'polygon', attr: { fill: '#3F51B5', points: '44,19 30,30.7 30,7.3' }, child: [] },
      {
    ...
    child: [
      {
        ...
        attr: { fill: '#3F51B5' },
        child: [
          { tag: 'polygon', attr: { points: '24,4 35.7,18 12.3,18' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '15', width: '8', height: '27' }, child: [] },
        ],
      },
    ],
  })(props);
    ...
    child: [
      {
        ...
        attr: { fill: '#009688' },
        child: [
          { tag: 'polygon', attr: { points: '24,10.9 35,24 13,24' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '40', width: '8', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '34', width: '8', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '20', y: '21', width: '8', height: '11' }, child: [] },
          { tag: 'rect', attr: { x: '6', y: '4', width: '36', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
...
function FcVideoFile(props) {
  return GenIcon({
    ...
    child: [
      { tag: 'polygon', attr: { fill: '#90CAF9', points: '40,45 8,45 8,3 30,3 40,13' }, child: [] },
      { tag: 'polygon', attr: { fill: '#E1F5FE', points: '38.5,14 29,14 29,4.5' }, child: [] },
      { tag: 'polygon', attr: { fill: '#1976D2', points: '30,28 20,22 20,34' }, child: [] },
    ],
  })(props);
}
    ...
    child: [
      {
        ...
        attr: { fill: '#546E7A' },
        child: [
          { tag: 'rect', attr: { x: '5', y: '34', width: '6', height: '3' }, child: [] },
          { tag: 'rect', attr: { x: '37', y: '34', width: '6', height: '3' }, child: [] },
        ],
      },
      {
        tag: 'path',
      ...
      },
      {
        ...
        attr: { fill: '#37474F' },
        child: [
          { tag: 'rect', attr: { x: '5', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '5', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '5', y: '27', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '9', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '9', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '9', y: '27', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '27', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '17', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '17', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '17', y: '27', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '19', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '23', width: '2', height: '2' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '27', width: '2', height: '2' }, child: [] },
        ],
      },
      { tag: 'circle', attr: { fill: '#37474F', cx: '37', cy: '24', r: '8' }, child: [] },
      { tag: 'circle', attr: { fill: '#a0f', cx: '37', cy: '24', r: '6' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#EA80FC',
...
function FcViewDetails(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '7', y: '4', fill: '#BBDEFB', width: '34', height: '40' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#2196F3' },
        child: [
          { tag: 'rect', attr: { x: '13', y: '26', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '18', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '34', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '13', y: '10', width: '4', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '26', width: '14', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '18', width: '14', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '34', width: '14', height: '4' }, child: [] },
          { tag: 'rect', attr: { x: '21', y: '10', width: '14', height: '4' }, child: [] },
        ],
      },
    ],
  })(props);
  ...
  return GenIcon({
    ...
    child: [
      ...
      },
      {
        ...
        attr: { fill: '#FFD54F' },
        child: [
          { tag: 'path', attr: { d: 'M15.9,28l2.1-9.1h2.8l-3.6,12.6h-2.6L11,18.9h2.8L15.9,28z' }, child: [] },
          { tag: 'path', attr: { d: 'M25.6,31.5h-2.5V18.9h2.5V31.5z' }, child: [] },
          {
            tag: 'path',
            attr: {
...
function FcVoicePresentation(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fill: '#2196F3', d: 'M40,22h-8l-4,4V12c0-2.2,1.8-4,4-4h8c2.2,0,4,1.8,4,4v6C44,20.2,42.2,22,40,22z' },
        child: [],
      },
      { tag: 'circle', attr: { fill: '#FFA726', cx: '17', cy: '19', r: '8' }, child: [] },
      { tag: 'path', attr: { fill: '#607D8B', d: 'M30,36.7c0,0-3.6-6.7-13-6.7S4,36.7,4,36.7V40h26V36.7z' }, child: [] },
    ],
  })(props);
}
...
function FcWebcam(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'circle', attr: { fill: '#78909C', cx: '24', cy: '23', r: '18' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#455A64',
      ...
      { tag: 'circle', attr: { fill: '#42A5F5', cx: '24', cy: '23', r: '9' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#90CAF9',
    ...
    child: [
      {
        ...
        child: [
          ...
          { tag: 'ellipse', attr: { fill: '#3F51B5', cx: '24', cy: '24', rx: '14.902', ry: '15' }, child: [] },
        ],
      },
      {
        tag: 'g',
        ...
        child: [
          {
            ...
            attr: {
              fill: '#FFFFFF',
              points:
                '17,19 14.264,19 13.427,24.859 12.388,19.028 9.93,19.028 8.864,24.859 8.054,19.028 5.266,19.028 \r\n		7.597,29 10.056,29 11.12,22.854 12.209,29 14.693,29 	',
            },
            child: [],
          },
          { tag: 'rect', attr: { x: '19', y: '22', fill: '#FFFFFF', width: '2.508', height: '7' }, child: [] },
          {
            tag: 'path',
            attr: {
              fill: '#FFFFFF',
...
function FcWorkflow(props) {
  return GenIcon({
    ...
    attr: { version: '1', viewBox: '0 0 48 48', enableBackground: 'new 0 0 48 48' },
    child: [
      { tag: 'rect', attr: { x: '7', y: '31', fill: '#00BCD4', width: '10', height: '10' }, child: [] },
      {
        tag: 'path',
        attr: {
          fill: '#00BCD4',
      ...
      { tag: 'circle', attr: { fill: '#3F51B5', cx: '12', cy: '13', r: '6' }, child: [] },
      { tag: 'circle', attr: { fill: '#448AFF', cx: '36', cy: '36', r: '6' }, child: [] },
      {
        tag: 'g',
        attr: { fill: '#90A4AE' },
        child: [
          { tag: 'rect', attr: { x: '11', y: '24', width: '2', height: '5' }, child: [] },
          { tag: 'polygon', attr: { points: '12,21 9,25 15,25' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#90A4AE' },
        child: [
          { tag: 'rect', attr: { x: '20', y: '12', width: '5', height: '2' }, child: [] },
          { tag: 'polygon', attr: { points: '28,13 24,10 24,16' }, child: [] },
        ],
      },
      {
        tag: 'g',
        attr: { fill: '#90A4AE' },
        child: [
          { tag: 'rect', attr: { x: '35', y: '21', width: '2', height: '5' }, child: [] },
          { tag: 'polygon', attr: { points: '36,29 39,25 33,25' }, child: [] },
        ],
      },
    ],
  })(props);
