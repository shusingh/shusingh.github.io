import { __commonJS, __toESM, require_react } from './chunk-JRE55LYH.js';
        ...
        switch (character2) {
          ...
          case 59 + offset:
            ...
            if (property > 0 && strlen(characters2) - length2)
              append(
                property > 32
                  ? declaration(characters2 + ';', rule, parent, length2 - 1, declarations)
                  : declaration(replace(characters2, ' ', '') + ';', rule, parent, length2 - 2, declarations),
                declarations
              );
            break;
          // @ ;
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2, siblings) {
  ...
  for (var i2 = 0, j2 = 0, k2 = 0; i2 < index; ++i2)
    for (var x2 = 0, y2 = substr(value, post + 1, (post = abs((j2 = points[i2])))), z2 = value; x2 < size; ++x2)
      if ((z2 = trim(j2 > 0 ? rule[x2] + ' ' + y2 : replace(y2, /&\f/g, rule[x2])))) props[k2++] = z2;
        ...
        switch (charat(value, length2 + 1)) {
          ...
          case 115:
            return ~indexof(value, 'stretch', 0)
              ? prefix(replace(value, 'stretch', 'fill-available'), length2, children) + value
              : value;
        }
      break;
    // grid-(column|row)
...
// node_modules/styled-components/dist/styled-components.browser.esm.js
var f =
  ('undefined' != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR)) ||
  'data-styled';
var m = 'active';
...
var J =
  (((V = {})[W] = { $$typeof: true, render: true, defaultProps: true, displayName: true, propTypes: true }),
  (V[Y] = U),
  V);
function X(e) {
...
var Pe = function (e, t) {
  for (
    var n, o2 = (null !== (n = t.textContent) && void 0 !== n ? n : '').split(g), r2 = [], s2 = 0, i2 = o2.length;
    s2 < i2;
    s2++
  ) {
    var a2 = o2[s2].trim();
...
var ke = (function () {
  ...
  return (
    ...
    (e.prototype.reconstructWithOptions = function (n, o2) {
      return (
        void 0 === o2 && (o2 = true),
        new e(__assign(__assign({}, this.options), n), this.gs, (o2 && this.names) || void 0)
      );
    }),
...
function Ve(e, t) {
  return e.map(function (e2) {
    return (
      ...
      Array.isArray(e2.children) && '@keyframes' !== e2.type && (e2.children = Ve(e2.children, t)),
      e2
    );
  });
}
    ...
    l2 = (0, import_react.useMemo)(
      function () {
        ...
        return (
          ...
          e.disableCSSOMInjection && (t2 = t2.reconstructWithOptions({ useCSSOMInjection: false })),
          t2
        );
      },
  ...
  for (var s2 in t) {
    ...
    t.hasOwnProperty(s2) &&
      ...
      ((Array.isArray(i2) && i2.isCss) || re(i2)
        ...
        : ce(i2)
          ? r2.push.apply(r2, __spreadArray(__spreadArray([''.concat(s2, ' {')], Je(i2), false), ['}'], false))
          : r2.push(
              ''
                .concat(He(s2), ': ')
                .concat(
                  ...
                  null == (o2 = i2) || 'boolean' == typeof o2 || '' === o2
                    ? ''
                    : 'number' != typeof o2 || 0 === o2 || n in unitlessKeys || n.startsWith('--')
                      ? String(o2).trim()
                      : ''.concat(o2, 'px')),
                  ';'
                )
      ...
      if (this.isStatic && !n.hash)
        ...
        if (c2) {
          ...
          t.hasNameForId(this.componentId, d) ||
            t.insertRules(this.componentId, d, n(c2, '.'.concat(d), void 0, this.componentId)),
            (o2 = ie(o2, d));
        }
      }
      return o2;
...
function it(e, r2, s2) {
  ...
  function O2(e2, r3) {
    return (function (e3, r4, s3) {
      ...
      var v2 = I(r4, f3, c3) || C,
        g3 = (function (e4, n, o2) {
          for (
            var r5, s4 = __assign(__assign({}, n), { className: void 0, theme: o2 }), i4 = 0;
            i4 < e4.length;
            i4 += 1
          ) {
  ...
  return (
    ...
    (D2.foldedComponentIds = i2 ? ie(a2.foldedComponentIds, a2.styledComponentId) : ''),
    ...
    (D2.warnTooManyClasses = /* @__PURE__ */ (function (e2, t) {
      ...
      return function (r3) {
        if (!o2 && ((n[r3] = true), Object.keys(n).length >= 200)) {
          ...
          console.warn(
            'Over '.concat(200, ' classes were generated for component ').concat(e2).concat(s3, '.\n') +
  ...
  var l2 = function (e) {
    ...
    return (
      import_react.default.Children.count(e.children) &&
        console.warn(
          'The global style component '.concat(a2, ' was given child JSX. createGlobalStyle does not render children.')
        ),
      i2.some(function (e2) {
...
var vt = (function () {
  function e() {
    ...
    (this._emitSheetCSS = function () {
      ...
      var n = Ce(),
        o2 = ae(
          [n && 'nonce="'.concat(n, '"'), ''.concat(f, '="true"'), ''.concat(y, '="').concat(v, '"')].filter(Boolean),
          ' '
        );
      ...
      (this.getStyleElement = function () {
        ...
        if (!r2) return [];
        var s2 = (((n = {})[f] = ''), (n[y] = v), (n.dangerouslySetInnerHTML = { __html: r2 }), n),
          i2 = Ce();
        return (
          i2 && (s2.nonce = i2), [import_react.default.createElement('style', __assign({}, s2, { key: 'sc-0-0' }))]
        );
      }),
      (this.seal = function () {
        e2.sealed = true;
